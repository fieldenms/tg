...
CREATE TABLE TGVEHICLE_ ( _ID INT NOT NULL PRIMARY KEY, _VERSION INT NOT NULL DEFAULT 0,KEY_ VARCHAR(255), DESC_ VARCHAR(255),  INITDATE_ DATETIME NULL, PRICE_ DECIMAL(10, 2), PURCHASEPRICE_ DECIMAL(10, 2), MODEL_ INT, 
STATION_ INT,
REPLACEDBY_ INT,
CONSTRAINT FK_VEH_ID_VEH_MODEL FOREIGN KEY(MODEL_) REFERENCES TGVEHICLEMODEL_(_ID)); 
