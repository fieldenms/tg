 ...
 */
@Deprecated
public class PlatformDbDrivenTestCaseConfiguration2 implements IDbDrivenTestCaseConfiguration {
    protected final EntityFactory entityFactory;
    protected final Injector injector;
    protected final HibernateUtil hibernateUtil;

    private final DaoTestHibernateModule2 hibernateModule;
     ...
     */
    public PlatformDbDrivenTestCaseConfiguration2() {
	...
	try {
	    ...
	    hibernateModule = new DaoTestHibernateModule2(hibernateUtil.getSessionFactory(), domainPersistenceMetadata);
