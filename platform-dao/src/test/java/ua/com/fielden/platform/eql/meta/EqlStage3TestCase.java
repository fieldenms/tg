...
//    }
    ...
    protected static Yield3 yieldSingleExpr(final String propName, final ISource3 source, final Class<? extends AbstractEntity<?>> propType) {
        return yieldEntityExpr(propName, source, "", propType);
    }

    protected static Yield3 yieldSingleStringExpr(final String propName, final ISource3 source) {
        return yieldStringExpr(propName, source, "");
    }

    protected static Yield3 yieldSingleExpr(final String propName, final ISource3 source) {
