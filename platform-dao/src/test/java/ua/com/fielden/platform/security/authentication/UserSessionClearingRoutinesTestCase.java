...
public class UserSessionClearingRoutinesTestCase extends AbstractDaoTestCase {
    ...
    protected void populateDomain() {
        ...
        final User user1 = coUser.save(new_(User.class, "USER1").setBase(true).setActive(true));
        save(new_(TgPerson.class, "Person 1").setUser(user1));
        final User user2 = coUser.save(new_(User.class, "USER2").setBase(true).setActive(true));
