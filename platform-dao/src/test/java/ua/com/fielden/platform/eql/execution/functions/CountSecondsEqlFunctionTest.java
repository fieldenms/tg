...
public class CountSecondsEqlFunctionTest extends AbstractEqlExecutionTestCase {

    @Test
    public void works_when_both_the_start_and_end_date_is_within_the_same_minute() {
        final var qry = select().yield().
                count().seconds().between().
                val(date("2007-01-01 00:01:34")).
                and().
                val(date("2007-01-01 00:01:14")).
                as(RESULT).modelAsAggregate();
        assertEquals(valueOf(20), retrieveResult(qry));
    }

    @Test
    public void works_when_both_the_start_and_end_date_is_within_the_same_minute_and_the_end_date_precedes_the_start_date() {
        final var qry = select().yield().
                count().seconds().between().
                val(date("2007-01-01 00:01:14")).
                and().
    ...
    public void works_when_both_the_start_and_end_date_is_within_the_same_hour() {
        final var qry = select().yield().
                count().seconds().between().
                val(date("2007-01-01 01:50:05")).
                and().
                val(date("2007-01-01 01:29:45")).
                as(RESULT).modelAsAggregate();
        assertEquals(valueOf(1220), retrieveResult(qry));
    }
    ...
    public void works_when_both_the_start_and_end_date_is_within_the_same_day() {
        final var qry = select().yield().
                ...
                as(RESULT).modelAsAggregate();
        assertEquals(valueOf(6025), retrieveResult(qry));
    }
    ...
    public void works_when_both_the_start_and_end_date_is_within_the_same_month() {
        final var qry = select().yield().
                ...
                val(date("2007-01-01 18:30:15")).
                as(RESULT).modelAsAggregate();
        assertEquals(valueOf(180050), retrieveResult(qry));
    }
    ...
    public void works_when_both_the_start_and_end_date_is_within_the_same_year() {
        final var qry = select().yield().
                ...
                as(RESULT).modelAsAggregate();
        assertEquals(valueOf(149385), retrieveResult(qry));
    }
    ...
    public void works_when_the_start_date_year_differs_from_the_end_date_year() {
        final var qry = select().yield().
                ...
                as(RESULT).modelAsAggregate();
        assertEquals(valueOf(216062), retrieveResult(qry));
    }
    ...
    public void works_when_the_start_date_is_value_and_the_end_date_is_property() {
        final var qry = select(TeNamedValuesVector.class).yield().
                ...
                prop("dateOf20010911").
                as(RESULT).modelAsAggregate();
        assertEquals(valueOf(3661), retrieveResult(qry));
    }
    ...
    public void works_when_the_start_date_is_function_and_the_end_date_is_subquery() {
        final var qry = select(TeNamedValuesVector.class).yield().
                count().seconds().between().
                ifNull().prop("dateOfNullValue").then().val(date("2001-09-11 00:00:01")).
                and().
    ...
    public void works_when_the_function_result_is_used_within_other_query_expressions_and_conditions() {
        final var qry = select(TeNamedValuesVector.class).yield().
                caseWhen().count().seconds().between().val(date("2001-01-01 01:01:01")).and().val(date("2001-01-01 00:00:00")).eq().val(3661).then().val(1).end().
                as(RESULT).modelAsAggregate();
        assertEquals(valueOf(1), retrieveResult(qry));
    }

    @Test
    public void fails_when_the_result_exceeds_integer_upper_bound() {
        try {
            retrieveResult(
                    select().yield().
                    count().seconds().between().
                    val(date("2069-01-01 00:00:00")).
                    and().
                    val(date("2000-01-01 00:00:00")).
                    as(RESULT).modelAsAggregate()
                    );
            fail("Trying to obtain result that exceeds the upper bound of Integer type should have failed.");
