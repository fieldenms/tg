...
public class QueryModelCompositionTest extends BaseEntQueryCompositionTCase {
	...
	others.add(new CompoundSource(new TypeBasedSource(TgWorkOrder.class, "wo", DOMAIN_PERSISTENCE_METADATA_ANALYSER), JoinType.IJ, condition1));
	others.add(new CompoundSource(new TypeBasedSource(TgWorkOrder.class, "wo2", DOMAIN_PERSISTENCE_METADATA_ANALYSER), JoinType.LJ, condition2));

	final EntQuery act = entResultQry(qry);
	final Sources exp = new Sources(new TypeBasedSource(VEHICLE, "v", DOMAIN_PERSISTENCE_METADATA_ANALYSER), others);
	...
	final List<CompoundSource> others = new ArrayList<CompoundSource>();
	others.add(new CompoundSource(new TypeBasedSource(WORK_ORDER, "wo", DOMAIN_PERSISTENCE_METADATA_ANALYSER), JoinType.IJ, condition));
	...
	final List<CompoundSource> others = new ArrayList<CompoundSource>();
	others.add(new CompoundSource(new TypeBasedSource(WORK_ORDER, null, DOMAIN_PERSISTENCE_METADATA_ANALYSER), JoinType.IJ, condition));
	...
	final List<CompoundSource> others = new ArrayList<CompoundSource>();
	others.add(new CompoundSource(new TypeBasedSource(WORK_ORDER, "wo", DOMAIN_PERSISTENCE_METADATA_ANALYSER), JoinType.IJ, condition1));
	others.add(new CompoundSource(new TypeBasedSource(WORK_ORDER, "wo2", DOMAIN_PERSISTENCE_METADATA_ANALYSER), JoinType.LJ, condition2));
	...
	final Sources exp = new Sources(new QueryBasedSource("v", DOMAIN_PERSISTENCE_METADATA_ANALYSER, entSourceQry(sourceQry)), new ArrayList<CompoundSource>());
	assertEquals("models are different", exp, entResultQry(qry).getSources());
    }
...
//    }
	...
	final List<CompoundSource> others = new ArrayList<CompoundSource>();
	final Sources exp = new Sources(new TypeBasedSource(VEHICLE, null, DOMAIN_PERSISTENCE_METADATA_ANALYSER), others);
	assertEquals("models are different", exp, entResultQry(qry).getSources());
    }
