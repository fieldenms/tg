...
public class GlobalDomainTreeManagerTest extends GlobalDomainTreeRepresentationTest {
    ...
    @Test
    public void test_that_PRINCIPLE_CENTRE_initialisation_works_fine_for_BASE_user() {
	final IGlobalDomainTreeManager baseMgr = createManagerForBaseUser();
	baseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
    ...
    @Test
    public void test_that_PRINCIPLE_CENTRE_initialisation_works_fine_for_NON_BASE_user() {
	final IGlobalDomainTreeManager nonBaseMgr = createManagerForNonBaseUser();
	nonBaseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
	...
	nonBaseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
	assertNotNull("Should be initialised.", nonBaseMgr.getEntityCentreManager(MENU_ITEM_TYPE, null));
	EntityUtils.equalsEx(baseMgr.getEntityCentreManager(MENU_ITEM_TYPE, null), nonBaseMgr.getEntityCentreManager(MENU_ITEM_TYPE, null));
    }

    @Test
    public void test_that_PRINCIPAL_CENTRE_initialisation_does_not_save_anything_for_BASE_user() {
	final IGlobalDomainTreeManager baseMgr = createManagerForBaseUser();
	baseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
    ...
    @Test
    public void test_that_PRINCIPAL_CENTRE_initialisation_does_not_save_anything_for_NON_BASE_user() {
	final IGlobalDomainTreeManager nonBaseMgr = createManagerForNonBaseUser();
	nonBaseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
    ...
    @Test
    public void test_that_PRINCIPLE_CENTRE_saving_saves_it_for_BASE_user() {
	final IGlobalDomainTreeManager baseMgr = createManagerForBaseUser();
	baseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
    ...
    @Test
    public void test_that_PRINCIPLE_CENTRE_saving_fails_for_NON_BASE_user() {
	final IGlobalDomainTreeManager nonBaseMgr = createManagerForNonBaseUser();
	nonBaseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
    ...
    @Test
    public void test_that_CENTRE_saveAs_leads_to_sorted_non_principle_centres_for_BASE_user() {
	// create PRINCIPLE and BASE/NON-BASE SAVE AS REPORTS for user USER2
	final IGlobalDomainTreeManager baseMgr = createManagerForBaseUser();
	baseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
	baseMgr.saveAsEntityCentreManager(MENU_ITEM_TYPE, null, "b");
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("b"); }}, baseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
	baseMgr.saveAsEntityCentreManager(MENU_ITEM_TYPE, null, "a");
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("a"); add("b"); }}, baseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
	baseMgr.saveAsEntityCentreManager(MENU_ITEM_TYPE, null, "c");
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("a"); add("b"); add("c"); }}, baseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
    }

    @Test
    public void test_that_CENTRE_saveAs_leads_to_sorted_non_principle_centres_for_NON_BASE_user() {
	...
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("d"); }}, baseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
	baseMgr.saveAsEntityCentreManager(MENU_ITEM_TYPE, null, "c");
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("c"); add("d"); }}, baseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
	baseMgr.saveAsEntityCentreManager(MENU_ITEM_TYPE, null, "e");
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("c"); add("d"); add("e"); }}, baseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));

	// create principle and non-principle reports for user USER2 and check the order
	final IGlobalDomainTreeManager newNonBaseMgr = createManagerForNonBaseUser();
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("c"); add("d"); add("e"); }}, newNonBaseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
	...
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("b"); add("c"); add("d"); add("e"); }}, newNonBaseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
	newNonBaseMgr.saveAsEntityCentreManager(MENU_ITEM_TYPE, null, "m");
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("b"); add("c"); add("d"); add("e"); add("m"); }}, newNonBaseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
    }
	...
	baseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
	baseMgr.saveAsEntityCentreManager(MENU_ITEM_TYPE, null, "BASE SAVE AS REPORT");
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("BASE SAVE AS REPORT"); }}, baseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
	final IGlobalDomainTreeManager nonBaseMgr = createManagerForNonBaseUser();
	...
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("BASE SAVE AS REPORT"); add("NON-BASE SAVE AS REPORT"); }}, nonBaseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
	...
	assertEquals("Incorrect non-principle names of entity-centres.", new ArrayList<String>() {{ add("BASE SAVE AS REPORT"); add("NON-BASE SAVE AS REPORT"); }}, newNonBaseMgr.nonPrincipleEntityCentreNames(MENU_ITEM_TYPE));
    }

    @Test
    public void test_that_nonPrincipleEntityCentreNames_works_for_not_initialised_centres() {
	// create PRINCIPLE and BASE/NON-BASE SAVE AS REPORTS for user USER2
	final IGlobalDomainTreeManager baseMgr = createManagerForBaseUser();
	baseMgr.initEntityCentreManager(MENU_ITEM_TYPE, null);
	baseMgr.saveAsEntityCentreManager(MENU_ITEM_TYPE, null, "BASE SAVE AS REPORT");
