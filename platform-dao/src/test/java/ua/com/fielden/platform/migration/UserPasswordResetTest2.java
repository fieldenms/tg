 ...
 *
 */
public class UserPasswordResetTest2 extends DbDrivenTestCase2 {
    private final IUserController2 controller = injector.getInstance(IUserController2.class);
    ...
    public UserPasswordResetTest2() throws Exception {
	super();
	cypher = new Cypher();
    }
