...
public class UserPasswordResetTest extends AbstractDaoTestCase {
    ...
    protected void populateDomain() {
        ...
        save(new_(User.class, "USER1").setBase(true).setPassword("PASSWORD-1").setEmail("USER1@unit-test.software").setActive(true));
        save(new_(User.class, "USER2").setBase(true).setPassword("PASSWORD-2").setEmail("USER2@unit-test.software").setActive(true));
    }
}