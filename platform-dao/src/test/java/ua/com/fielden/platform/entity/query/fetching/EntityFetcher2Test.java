...
public class EntityFetcher2Test extends AbstractDomainDrivenTestCase {

    private final ITgVehicleModel2 dao = getInstance(ITgVehicleModel2.class);
	...
	final List<TgVehicleModel> models = dao.getAllEntities(from(model).build());
