...
public class PropertyPresenceTest extends BaseEntQueryTCase {
	...
	assertPropInfoEquals(qry, "id", propResInf("id", null, ppi("id", LONG, Hibernate.LONG, false), ppi("id", LONG, Hibernate.LONG, false)));
	assertPropInfoEquals(qry, "key", propResInf("key", null, ppi("key", STRING, Hibernate.STRING, false), ppi("key", STRING, Hibernate.STRING, false)));
	assertPropInfoEquals(qry, "desc", propResInf("desc", null, ppi("desc", STRING, Hibernate.STRING, true), ppi("desc", STRING, Hibernate.STRING, true)));
	assertPropInfoEquals(qry, "model", propResInf("model", null, ppi("model", MODEL, Hibernate.LONG, false), ppi("model", MODEL, Hibernate.LONG, false)));
