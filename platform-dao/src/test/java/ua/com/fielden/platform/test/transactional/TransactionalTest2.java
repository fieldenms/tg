 ...
 *
 */
public class TransactionalTest2 extends DbDrivenTestCase2 {
    private LogicThatNeedsTransaction2 logic;
	...
	logic = injector.getInstance(LogicThatNeedsTransaction2.class);
