...
public class DomainPersistenceMetadataTest extends BaseEntQueryTCase {
	...
	final EntityMetadata makeCountMetadata = DOMAIN_PERSISTENCE_METADATA.generateEntityPersistenceMetadata(TgVehicleMake.class);
	...
	final EntityMetadata makeCountMetadata = DOMAIN_PERSISTENCE_METADATA.generateEntityPersistenceMetadata(TgMakeCount.class);
	makeCountMetadata.getProps();
