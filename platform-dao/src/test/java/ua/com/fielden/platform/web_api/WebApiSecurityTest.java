...
public class WebApiSecurityTest extends AbstractDaoTestCase {
    ...
    private void removeAccessTo(final Class<? extends ISecurityToken> token) {
        final SecurityRoleAssociationCo securityRoleAssociationCo = co(SecurityRoleAssociation.class);
        securityRoleAssociationCo.removeAssociations(setOf(
            securityRoleAssociationCo.new_()
