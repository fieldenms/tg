...
public class CollectionModificationValidationTest extends AbstractDaoTestCase {
    ...
    public void available_entities_are_ordered_by_key_and_such_order_does_not_mutate_during_validation_cycles_in_userRole_tokens_collectional_editor() {
        ...
        final HashSet<SecurityTokenInfo> expectedTokens = setOf(
            ...
            createTokenInfo.apply(DurationUnit_CanRead_Token.class),
            createTokenInfo.apply(DurationUnit_CanReadModel_Token.class),
            createTokenInfo.apply(Duration_CanSave_Token.class),
            createTokenInfo.apply(Duration_CanRead_Token.class),
            createTokenInfo.apply(Duration_CanReadModel_Token.class),
            createTokenInfo.apply(Duration_CanDelete_Token.class),
            createTokenInfo.apply(DurationMaster_CanOpen_Token.class),
