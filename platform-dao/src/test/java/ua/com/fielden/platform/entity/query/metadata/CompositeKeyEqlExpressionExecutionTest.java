...
public class CompositeKeyEqlExpressionExecutionTest extends AbstractDaoTestCase {
    ...
    @Test
    public void Money_key_member_with_positive_value() {
        final var entity = save(new_(CompositeKeyEqlExpression_Entity12.class)
                .setName("alpha")
                .setPrice(Money.of("100").withCurrency(Currency.getInstance("EUR"))));
        assertKeyEquals("alpha € 100.00", entity);
    }

    @Test
    public void Money_key_member_with_negative_value() {
        final var entity = save(new_(CompositeKeyEqlExpression_Entity12.class)
                .setName("alpha")
                .setPrice(Money.of("-100").withCurrency(Currency.getInstance("EUR"))));
        assertKeyEquals("alpha -€ 100.00", entity);
