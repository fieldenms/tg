...
/**
 * A test case for "development" => "deployment" menu items migration utility.
 * See {@link MainMenuItemMixin#updateMenuItemsWithDevelopmentOnes(ua.com.fielden.platform.ui.config.api.IMainMenuStructureBuilder, String)} method.
 *
 * @author TG Team
 *
 */
public class UpdateDeploymentItemsByDevelopmentItemsTest extends AbstractDomainDrivenTestCase {
	...
	public List<MainMenuItem> build() {
		...
		.push("type1")
			.push("type2")
				.push("type3")
					.push("type3").pop().pop().pop() // non-persistent "saveAs"-related menu item
			.push("type4")
				.push("type5")
					.push("type5").pop().pop().pop().pop() // non-persistent "saveAs"-related menu item
		.push("type6")
			.push("type7")
				.push("type7").pop().pop().pop(); // non-persistent "saveAs"-related menu item
		return super.build();
	}
    }
	...
	for (int i = 0; i < expected.size(); i++) {
		...
		System.err.println("The " + i + "-th element in list " + expected + " is not equal to appropriate actual element due to different children => expected = " + expected.get(i).getChildren() + ", actual = " + actual.get(i).getChildren() + ".");
		return false;
	    }
	}
	return true;
	...
	public List<MainMenuItem> build() {
		...
		.push("type1")
			...
			.push("type4")
				.push("type5")
					.push("type5").pop().pop().pop() // non-persistent "saveAs"-related menu item
			.push("type_added").pop().pop()
		.push("type6")
			.push("type7")
				.push("type7").pop().pop().pop(); // non-persistent "saveAs"-related menu item
	...
	public List<MainMenuItem> build() {
		...
		.push("type1")
			...
			.push("type4")
				.push("type5")
					.push("type5").pop().pop()
				.push("type_added").pop().pop().pop() // non-persistent "saveAs"-related menu item
		.push("type6")
			.push("type7")
				.push("type7").pop().pop().pop(); // non-persistent "saveAs"-related menu item
		return super.build();
	...
	public List<MainMenuItem> build() {
		...
		.push("type1")
			.push("type2")
				.push("type3")
					.push("type3").pop().pop().pop().pop() // non-persistent "saveAs"-related menu item
		.push("type6")
			.push("type7")
				.push("type7").pop().pop().pop(); // non-persistent "saveAs"-related menu item
		return super.build();
	...
	public List<MainMenuItem> build() {
	    structureFactory()
	    	.push("type_modified_1")
	    		.push("type7").pop().pop()
		.push("type_modified_2")
			.push("type4").pop()
	    		.push("type_modified_3")
	    			.push("type3").pop()
	    			.push("type_added").pop()
	    			.pop().pop();
		return super.build();
	...
	public List<MainMenuItem> build() {
		...
		.push("type_modified_2")
			...
			.push("type_modified_3")
				.push("type3")
					.push("type3").pop().pop() // non-persistent "saveAs"-related menu item
				.push("type_added").pop().pop().pop();
		return super.build();
	}
    }
