...
import ua.com.fielden.platform.sample.domain.TgLocationDao;
...
import ua.com.fielden.platform.sample.domain.TgMovementDao;
...
public class PlatformTestServerModule extends BasicWebServerModule {
    ...
    protected void configure() {
        ...
        bind(ITgLocation.class).to(TgLocationDao.class);
        bind(ITgMovement.class).to(TgMovementDao.class);
