...
public class DbDateUtilities extends DateUtilities {
    /**
     * This method initializes all date parameters that exist in "query" and are
     * relative to previously retrieved "currentDbDate". </br> For instance :
     * "BEG_PREV_MONTH", "MID_CURR_YEAR" or "END_NEXT_DAY" etc.
     *
     * @param query
     * @param currentDbDate
     * @return
