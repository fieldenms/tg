...
import ua.com.fielden.platform.eql.stage3.sources.Source3BasedOnVoid;

public class Source2BasedOnVoid implements ISource2<Source3BasedOnVoid> {
    ...
    public int hashCode() {
        final int prime = 31;
        final int result = 1;
        return prime * result + Source2BasedOnVoid.class.getName().hashCode();
    }
    
    @Override
    public boolean equals(final Object obj) {
        return this == obj || obj instanceof Source2BasedOnVoid;
    } 
}