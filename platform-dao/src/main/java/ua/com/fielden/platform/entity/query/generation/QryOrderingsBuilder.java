...
public class QryOrderingsBuilder extends AbstractTokensBuilder {
    ...
    protected QryOrderingsBuilder(final AbstractTokensBuilder parent, final EntQueryGenerator queryBuilder, final Map<String, Object> paramValues, final IDates dates) {
