...
public class QueryComponents2 {
    ...
    public QueryComponents2(final IJoinNode2<? extends IJoinNode3> joinRoot, final Conditions2 conditions, final Yields2 yields, final GroupBys2 groups, final OrderBys2 orderings) {
