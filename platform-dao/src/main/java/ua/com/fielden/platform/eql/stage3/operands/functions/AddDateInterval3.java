...
public class AddDateInterval3 extends TwoOperandsFunction3 {
    ...
    public String sql(final DbVersion dbVersion) {
        switch (dbVersion) {
        case POSTGRESQL:
            // Date operator needs to be explicitly typecasted to timestamp. (See for more details -- https://stackoverflow.com/questions/7475876/using-hibernate-query-colon-gets-treated-as-parameter-escaping-colon
