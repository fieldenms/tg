...
public class EntQuery1 extends AbstractElement1 implements ISingleOperand1<EntQuery2> {
    ...
    public TransformationResult<EntQuery2> transform(final PropsResolutionContext context) {
        ...
        final PropsResolutionContext resultResolutionContext = (isSubQuery() || isSourceQuery()) ? 
                new PropsResolutionContext(orderingsTr.updatedContext.getDomainInfo(), orderingsTr.updatedContext.getSources().subList(1, orderingsTr.updatedContext.getSources().size()), orderingsTr.updatedContext.getResolvedProps(), orderingsTr.updatedContext.sourceId) :
