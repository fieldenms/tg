...
public class AverageOfBuilder extends OneArgumentFunctionBuilder {
    ...
    protected AverageOfBuilder(final AbstractTokensBuilder parent, final EntQueryGenerator queryBuilder, final Map<String, Object> paramValues, final boolean distinct, final IUniversalConstants universalConstants) {
