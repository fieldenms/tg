...
public class DateOfBuilder extends OneArgumentFunctionBuilder {
    ...
    protected DateOfBuilder(final AbstractTokensBuilder parent, final EntQueryGenerator queryBuilder, final Map<String, Object> paramValues, final IUniversalConstants universalConstants) {
