...
/**
 * This Hibernate listener executes meta-information updating while the
 * instance's collection initializes (when the proxy becomes initialized
 * collection). It executes meta-definers and updates "original-value".
 *
 * @author Jhou
 *
 */
