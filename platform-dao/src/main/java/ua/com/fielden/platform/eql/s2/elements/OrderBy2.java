...
public class OrderBy2 {
    ...
    public OrderBy2(final ISingleOperand2 operand, final SortingOrderDirection sortingOrderDirection) {
        super();
    ...
    public OrderBy2(final String yieldName, final SortingOrderDirection sortingOrderDirection) {
        super();
        this.operand = null;
    ...
    public SortingOrderDirection getSortingOrder() {
