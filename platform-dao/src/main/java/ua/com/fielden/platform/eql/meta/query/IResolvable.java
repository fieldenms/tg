...
public interface IResolvable<T> {
    ...
    public static PropResolutionProgress resolve(final PropResolutionProgress context, final SortedMap<String, AbstractQuerySourceItem<?>> props) {
        if (context.isSuccessful()) {
            return context;
        } else {
            final AbstractQuerySourceItem<?> foundPart = props.get(context.getNextPending());
