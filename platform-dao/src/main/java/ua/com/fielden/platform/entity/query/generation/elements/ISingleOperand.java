...
public interface ISingleOperand extends IPropertyCollector {
    /**
     * Indicates that operand should not be taken into account during model construction (this is used within implementation of ignore of conditions where one/both operands are
     * values with null as value.
     *
     * @return
     */
    boolean ignore();
