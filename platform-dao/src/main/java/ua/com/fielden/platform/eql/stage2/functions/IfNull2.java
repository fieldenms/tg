...
import ua.com.fielden.platform.eql.stage3.functions.IfNull3;
...
public class IfNull2 extends TwoOperandsFunction2<IfNull3> {
    ...
    public TransformationResult<IfNull3> transform(final TransformationContext context) {
        ...
        return new TransformationResult<IfNull3>(new IfNull3(firstOperandTransformationResult.item, secondOperandTransformationResult.item, type, hibType), secondOperandTransformationResult.updatedContext);
    }
