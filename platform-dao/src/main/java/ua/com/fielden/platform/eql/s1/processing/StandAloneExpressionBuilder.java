...
import ua.com.fielden.platform.eql.s1.elements.CompoundSingleOperand;
import ua.com.fielden.platform.eql.s1.elements.Expression;
...
public class StandAloneExpressionBuilder extends AbstractTokensBuilder {
    ...
    public StandAloneExpressionBuilder(final EntQueryGenerator1 queryBuilder, final Map<String, Object> paramValues, final ExpressionModel exprModel) {
