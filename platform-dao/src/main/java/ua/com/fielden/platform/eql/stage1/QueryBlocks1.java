...
public class QueryBlocks1 {
    ...
    public QueryBlocks1(final IJoinNode1<? extends IJoinNode2<?>> joinRoot, final Conditions1 conditions, final Conditions1 udfConditions, final Yields1 yields, final GroupBys1 groups, final OrderBys1 orderings, final boolean yieldAll) {
