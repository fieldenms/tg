...
public class Source1BasedOnPersistentType extends AbstractSource1<Source2BasedOnPersistentType> {
    ...
    @Override
    public Source2BasedOnPersistentType transform(final PropsResolutionContext context) {
        return new Source2BasedOnPersistentType(sourceType(), context.getDomainInfo().getEntityInfo(sourceType()), alias, transformId(context));
    }
