...
import ua.com.fielden.platform.eql.stage1.operands.functions.MinOf1;

public class MinOfBuilder extends OneArgumentFunctionBuilder {

    public MinOfBuilder(final AbstractTokensBuilder parent, final QueryModelToStage1Transformer queryBuilder) {
