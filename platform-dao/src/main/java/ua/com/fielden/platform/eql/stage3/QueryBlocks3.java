...
public class QueryBlocks3 {
    public final IJoinNode3 sources;
    ...
    public QueryBlocks3(final IJoinNode3 sources, final Conditions3 conditions, final Yields3 yields, final GroupBys3 groups, final OrderBys3 orderings) {
