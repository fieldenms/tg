...
abstract class TwoOperandsFunctionModel implements ISingleOperand {

    private final ISingleOperand operand1;
    private final ISingleOperand operand2;

    public TwoOperandsFunctionModel(final ISingleOperand operand1, final ISingleOperand operand2) {
	super();
	...
	if (!(obj instanceof TwoOperandsFunctionModel)) {
	    return false;
	}
	final TwoOperandsFunctionModel other = (TwoOperandsFunctionModel) obj;
	if (operand1 == null) {
