...
public class IfNull2 extends TwoOperandsFunction2<IfNull3> {
    ...
    public TransformationResult2<IfNull3> transform(final TransformationContext2 context) {
        ...
        return new TransformationResult2<>(new IfNull3(firstOperandTransformationResult.item, secondOperandTransformationResult.item, type, hibType), secondOperandTransformationResult.updatedContext);
    }
