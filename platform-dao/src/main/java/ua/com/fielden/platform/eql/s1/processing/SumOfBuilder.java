...
public class SumOfBuilder extends OneArgumentFunctionBuilder {
    ...
    protected SumOfBuilder(final AbstractTokensBuilder parent, final EntQueryGenerator1 queryBuilder, final Map<String, Object> paramValues, final boolean distinct) {
