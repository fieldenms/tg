...
/**
 * This is a utility, which should be used to reset passwords for all users.
 * The need to do that is driven by migration from the old password encryption schema to a new one based on the RSA algorithm.
 * <p>
