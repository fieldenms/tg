...
public class CountOf1 extends SingleOperandFunction1<CountOf2> {
    ...
    @Override
    public TransformationResult<CountOf2> transform(final PropsResolutionContext context, final String sourceId) {
        final TransformationResult<? extends ISingleOperand2<? extends ISingleOperand3>> operandTr = operand.transform(context, sourceId);
