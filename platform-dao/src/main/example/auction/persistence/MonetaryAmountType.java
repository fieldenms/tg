...
/**
 * This type adds parameterizable currency conversion to the normal composite user type, that is, you can set the target currency for the conversion (for the value saved and loaded
 * from the database) to any ISO code in your mapping, depending on the situation/property to map. It maps a two-attribute component to two database columns.
 * <p>
 * Do not ask me how this currency conversion works. It doesn't work, it's not implemented. The whole point of this class is not to show how you can convert money, but how you can
 * write a custom UserType.
 * 
