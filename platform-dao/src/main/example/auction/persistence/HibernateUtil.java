 ...
 * <p>
 * Note: This class supports only one data store. Support for several <tt>SessionFactory</tt> instances can be easily added (through a static <tt>Map</tt>, for example). You
 * could then lookup a <tt>SessionFactory</tt> by its name.
 *
