...
public class TestUtil {
	...
	return HibernateUtil.getConfiguration().getProperty(Environment.CURRENT_SESSION_CONTEXT_CLASS);
    }

    public static void enableSessionContext(String currentSessionContextClassName) {
	HibernateUtil.getConfiguration().setProperty(Environment.CURRENT_SESSION_CONTEXT_CLASS, currentSessionContextClassName);
