...
/**
 * Returns Hibernate-specific instances of DAOs. <p/> If for a particular DAO there is no additional non-CRUD functionality, we use a nested static class to implement the interface
 * in a generic way. This allows clean refactoring later on, should the interface implement business data access methods at some later time. Then, we would externalize the
...
public class HibernateDAOFactory extends DAOFactory {
    ...
    public static class CategorizedItemDAOHibernate extends GenericHibernateDAO<CategorizedItem, CategorizedItem.Id> implements CategorizedItemDAO {
    }
