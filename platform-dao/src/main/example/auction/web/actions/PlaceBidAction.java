 ...
 * <p>
 * The primary purpose of this class is to show you how you can use the <tt>SessionTransactionInterceptor</tt> on your action classes, to get transparent database transaction
 * handling. This cross-cutting concern is completely separated from this controller, and the business code in the domain model.
 * 
...
public class PlaceBidAction implements Action {
	...
	try {
	    ...
	    MonetaryAmount newAmount = new MonetaryAmount(bidAmount, Currency.getInstance(Locale.US));
