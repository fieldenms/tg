 ...
 * 
 * An instance of this class is always associated with only one <tt>User</tt> and depends on that parent objects lifecycle, it is a component. Of course, other entity classes can
 * also embed addresses.
 * 
 * @see User
