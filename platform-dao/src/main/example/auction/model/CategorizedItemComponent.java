 ...
 * <p>
 * This is really a very special mapping. The CategorizedItemComponent class represents a join table. The ER model for this is really a many-to-many association, but instead of two
 * entities and two collections, we mapped this as a single collection (in Category) of composite elements, instances of this class. This simplifies the lifecycle of the
 * association. Navigation is however only possible from Category -> CategorizedItemComponent -> Item, not in the other direction.
 * 
 * @see Category
 * @see Item
