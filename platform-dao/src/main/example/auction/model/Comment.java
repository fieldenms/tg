 ...
 * <p>
 * Comments are always made in the context of an auction, that is, a comment has a reference to an Item. The comment has a free text field and a rating (using a typesafe
 * enumeration).
 * 
 * @see Item
 * @see User
...
public class Comment implements Serializable, Comparable {
	...
	if (o instanceof Comment) {
	    ...
	    return Long.valueOf(this.getCreated().getTime()).compareTo(Long.valueOf(((Comment) o).getCreated().getTime()));
	}
	return 0;
    }
