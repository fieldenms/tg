...
public class User implements Serializable, Comparable {
     ...
     * Full constructor
     */
    public User(String firstname, String lastname, String username, String password, String email, int ranking, boolean admin, Address homeAddress, Address billingAddress, AddressEntity shippingAddress, Set<BillingDetails> billingDetails, BillingDetails defaultBillingDetails, Set<Item> itemsForSale, Set<Item> boughtItems) {
     ...
     * <p>
     * This method checks if the removed is the default element, and will throw a BusinessException if there is more than one left to chose from. This might actually not be the
	...
	if (o instanceof User)
	    ...
	    return Long.valueOf(this.getCreated().getTime()).compareTo(Long.valueOf(((User) o).getCreated().getTime()));
	return 0;
    }
