...
/**
 * This is an event handler for handling D&D activities. The only difference from DragEventHandler is the way of determining that a node needs to be attached/detached from a
 * container -- node/container bounds intersection is used.
 * 
 * @author 01es
 * 
 */
public class IntersectionBasedDragEventHandler extends DragEventHandler {
    ...
    /**
     * A helper method for removing children of the node being tested for intersection.
     * 
     * @param nodes
     * @param parent
     */
    ...
    /**
     * This interface is used to specify custom action for double-click occurred on specified piccolo node.
     * 
     * @author Jhou
     * 
     */
