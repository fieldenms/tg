...
public class ToolTipNode extends AbstractNode {
     ...
     * @param text
     * @param whereToShow
     * @param tooltipPosition - determines, on what side of the tip point, tooltip will be displayed
     */
     ...
     * Displays a tool tip with <code>text</code> at position <code>whereToShow</code>.
     * <br>
     * <br>Note : tooltip will be diplayed on the {@link ToolTipPosition#RIGHT_BOTTOM} side of the tip point
     *
     * @param text
     * @param whereToShow
     */
