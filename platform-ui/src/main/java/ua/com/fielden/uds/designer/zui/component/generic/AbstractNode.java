...
/**
 * This class provides the basic functionality for visual nodes used in UDS
 * Designer framework. Majority of nodes, which form part of this framework or
 * need to interact with it should most likely extend AbstractNode.
 *
 * @author 01es
 */
public abstract class AbstractNode extends PPath implements IBasicNode, ILinkedNode {
    ...
    /**
     * layoutIgnorantNodes is a list of visual nodes, which are not taken into
     * account when performing nodes' layout
     */
    ...
    /**
     * Adjusts the bounds of the node to contain all children. Relocates
     * children in one column.
     *
     * @param animate
     */
    ...
    /**
     * This method is used by reshape() to determine new bounds. It can be
     * overridden in order to provide a custom border determination;
     *
     * @return
     */
	...
	final Rectangle2D newBounds = new Rectangle2D.Double(getBounds().getX(), getBounds().getY(),
		(getMinConstraint() != null && getMinConstraint().width > proposedWidth ? getMinConstraint().width : proposedWidth), (getMinConstraint() != null
			&& getMinConstraint().height > proposedHeight ? getMinConstraint().height : proposedHeight));
    ...
    /**
     * This method is responsible for horizontal layout of embedded components
    ...
    /**
     * This method is responsible for vertical layout of embedded components
     * from top to bottom.
     */
    @SuppressWarnings("unchecked")
	...
	// right bottom corner
	curveTo((float) (newBounds.getWidth()), (float) (newBounds.getHeight()), (float) (newBounds.getWidth()), (float) (newBounds.getHeight()), (float) (newBounds.getWidth()),
		(float) (newBounds.getHeight()) - (rightBottom ? curvature : 0.0f));
    ...
    /**
     * If necessary any descendant of AbstractNode may provide an optional ring
     * menu. By default there is no menu.
     *
     * @return
     */
