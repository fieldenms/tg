...
public abstract class GpsGridAnalysisView2<T extends AbstractEntity<?>, GVPTYPE extends GisViewPanel2<T>> extends GridAnalysisView<T, ICentreDomainTreeManagerAndEnhancer> {
    ...
    public GpsGridAnalysisView2(final GpsGridAnalysisModel2<T> model, final GpsGridConfigurationView2<T> owner) {
        super(model, owner);
        ...
        return new IDataPromotingListener<T, ICentreDomainTreeManagerAndEnhancer>() {
            ...
            public void beforeDataPromoting(final DataPromotingEvent<T, ICentreDomainTreeManagerAndEnhancer> event) {
                if (getGisViewPanel() != null) {
                    // TODO getGisViewPanel().setCalloutChangeShouldBeForced(false);
                }
    ...
    @Override
    public GpsGridAnalysisModel2<T> getModel() {
        return (GpsGridAnalysisModel2<T>) super.getModel();
    }
    ...
    @Override
    public GpsGridConfigurationView2<T> getOwner() {
        return (GpsGridConfigurationView2<T>) super.getOwner();
    }
