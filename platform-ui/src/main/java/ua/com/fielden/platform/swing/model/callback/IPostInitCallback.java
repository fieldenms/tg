...
/**
 *
 * UI models support an even loop. There is a special event called INIT_POST_ACTION that indicates completion of model initialisation stage.
 * Instances of this contract can be provided in order to customize post initialisation behaviour such as putting UI model into an edit mode.
 * <p>
