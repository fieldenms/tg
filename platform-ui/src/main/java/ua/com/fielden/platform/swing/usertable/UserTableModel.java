...
public class UserTableModel extends AbstractTableModel {
    ...
    /**
     * Set the list of {@link UserRole}s that should be displayed in the table header. Throws {@link NullPointerException} if the given userRoles parameter is null.
     * 
     * @param userRoles
     */
