...
public class DetailsDynamicEntityReview {
//<T extends AbstractEntity, DAO extends IEntityDao2<T>> extends UvCustomEntityCentre<T, DAO, EntityQueryCriteria<T, DAO>,BaseFrame,UmCustomEntityCentre<T,DAO,EntityQueryCriteria<T, DAO>,BaseFrame>> {
//
