...
public class EntityGridInspector<T extends AbstractEntity> extends HierarchicalTable {
    ...
    /**
     * Creates the table with filterable model and extracts the associated property table model. If the actual model of the given {@link FilterableTableModel} is not the instance
     * of {@link PropertyTableModel} then the {@link IllegalArgumentException} will be thrown.
     * 
    ...
    /**
     * This method rebuilds table by new {@link FilterableTableModel}. If the actual model of the given {@link FilterableTableModel} is not the instance of
     * {@link PropertyTableModel} then the {@link IllegalArgumentException} will be thrown.
     * 
     * @param tableModel
     */
    @SuppressWarnings("unchecked")
    ...
    public JToolTip createToolTip() {
        final JToolTip customTooltip = new JToolTip() {
            ...
            public void setTipText(final String tipText) {
                ...
                final String t = tipText == null ? "" : tipText;
                final String wrappedByHtml = t.contains("<br>") ? TitlesDescsGetter.addHtmlTag(TitlesDescsGetter.removeHtmlTag(t))
                        : TitlesDescsGetter.addHtmlTag(brdText(TitlesDescsGetter.removeHtmlTag(t), 50));
