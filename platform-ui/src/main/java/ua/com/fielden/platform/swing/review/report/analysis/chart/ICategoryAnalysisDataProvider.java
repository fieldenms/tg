 ...
 * @author TG Team
 *
 * @param <CDT> - Category data type.
 * @param <ADT> - Aggregated data type
 * @param <LDT> - Loaded data type (i.e. IPage or list of {@link EntityAggregates}).
 */
public interface ICategoryAnalysisDataProvider<CDT, ADT, LDT> {
     ...
     * 
     * @param index - the entry index from where the value of grouped by property should be retrieved.
     * @param category - the name of grouped by property.
     * @return
     */
     ...
     * 
     * @param index - the entry index from where the value of aggregated property should be retrieved.
     * @param aggregated - the name of the aggregated property.
     * @return
     */
