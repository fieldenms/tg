	...
	iconCreateFunction: function(cluster) {
		...
		for (var i = 0; i < count; i++) {
			if (markers[i] instanceof ArrowMarker) { // arrow marker
				...
				return L.divIcon({ // TODO !!!!!!!!!!!!!!! images/circle-red.png images/circle-purple.png images/circle-orange.png
					html: '<div class="img-overlay"><img src="images/circle-purple.png" /><div class="overlay" >&#x2194</div></div>',
...
chosenMarker = markers[Math.floor(count / 2)]; // use middle arrow marker as the marker for the cluster when no circle markers exist
		...
		return L.divIcon({
html: '<div class="img-overlay"><img src="images/arrow-blue.png" style="-webkit-transform: rotate(' + 
...
iconSize: new L.Point(24, 24)
		...
		// 	html: '<img src="images/arrow-blue.png" style="-webkit-transform: rotate(' + 
		// 	chosenMarker.options.angle + 
