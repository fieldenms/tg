...
public abstract class AbstractAnalysisDetailsData<T extends AbstractEntity<?>> {
    ...
    /**
     * Creates new {@link AbstractAnalysisDetailsData} with report name and it's analysis name to which this details data belongs to. Also specifies the details' entity type.
     * 
     * @param root
     * @param name
     * @param analysisName
    ...
    public String toString() {
        return (root == null ? "" : (root.getSimpleName() + " ")) + (StringUtils.isEmpty(name) ? "" : (name + " "))
