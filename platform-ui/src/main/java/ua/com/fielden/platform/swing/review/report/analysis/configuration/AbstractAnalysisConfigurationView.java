 ...
 * @param <CDTME>
 *            - The type of {@link ICentreDomainTreeManagerAndEnhancer} that represent the centre/locator that owns this analysis.
 * @param <ADTM>
 *            - The type of {@link IAbstractAnalysisDomainTreeManager} that holds information for this analysis.
 * @param <VT>
 *            - The type of {@link AbstractAnalysisReview} that represent the analysis view.
 */
    ...
    private ISelectionEventListener createSelectionListener() {
        return new ISelectionEventListener() {
            ...
            public void viewWasSelected(final SelectionEvent event) {
                ...
                case REPORT:
                    getPreviousView().select();
                    break;
                case WIZARD:
                    getPreviousWizard().select();
                    break;
                default:
                    break;
                }
