...
/**
 * A spinner UI control with property <code>editable</code>. This property ensures that while control is enabled its content cannot be changed. By default JSpinner can only be
 * disabled, but not made not editable.
 * 
 * @author TG Team
 * 
 */
public class EditableSpinner extends JSpinner {
    ...
    /**
     * A wrapper model used by this editable spinner, which redirects the calls to the provided model, but overrides the behaviour of the setValue method by taking into account the
     * editable property of the spinner.
     */
