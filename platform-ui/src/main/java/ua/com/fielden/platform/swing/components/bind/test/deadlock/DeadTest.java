...
public class DeadTest {
	...
	.setValidator(DeadEntity.class, DeadEntity.PROPERTY_ODOMETER, new HappyValidator())
	.setValidator(DeadEntity.class, DeadEntity.PROPERTY_ACT_ST, new HappyValidator());
