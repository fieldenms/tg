...
public interface IEntityMasterFactory<T extends AbstractEntity, DAO extends IEntityDao<T>> {
     ...
     * @param entity
     * @param vmf
     * @param locatorRetriever
     * @param classPath
     * @param packagePath
     * @param ownerView
     * @return
     */
    BaseFrame createMasterFrame(final IEntityProducer<T> entityProducer, final IEntityMasterCache cache, final T entity, final IValueMatcherFactory vmf, final ILocatorConfigurationRetriever locatorRetriever, IUmViewOwner ownerView);
