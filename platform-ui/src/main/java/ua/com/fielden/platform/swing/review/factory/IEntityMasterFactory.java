...
public interface IEntityMasterFactory<T extends AbstractEntity<?>, DAO extends IEntityDao2<T>> {
     ...
     * @return
     */
    BaseFrame createMasterFrame(final IEntityProducer<T> entityProducer, final IEntityMasterCache cache, final T entity, final IValueMatcherFactory2 vmf, final IMasterDomainTreeManager masterManager, IUmViewOwner ownerView);
