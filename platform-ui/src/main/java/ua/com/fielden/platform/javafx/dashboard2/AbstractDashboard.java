...
/**
 * A dashboard facility contains some number of items (e.g. sentinels, calendar, charts etc.) that should be displayed as an actual informational items. These items should be
 * easily refreshable and should alert the user in case of some bad situation.
 * 
 * @author TG Team
 * 
 */
