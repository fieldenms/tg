...
public class MiTgPersistentEntityWithProperties4 extends MiWithConfigurationSupport<TgPersistentEntityWithProperties> {
    ...
    public MiTgPersistentEntityWithProperties4(final TreeMenuWithTabs<?> treeMenu, final Injector injector, final ITreeMenuItemVisibilityProvider visibilityProvider) {
        super(caption, description, treeMenu, injector.getInstance(EntityCentreFactoryBinder.class), visibilityProvider, MiTgPersistentEntityWithProperties4.class, injector.getInstance(IGlobalDomainTreeManager.class));
    }
}