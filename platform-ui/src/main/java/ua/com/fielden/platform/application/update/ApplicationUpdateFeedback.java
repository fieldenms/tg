...
/**
 * This is a convenient client application update feedback facility, which outputs the relevant feedback information either onto the splash screen and/or a specially designed frame
 * with two progress bars to indicate the overall and individual jar file download progress.
 * 
 * @author TG Team
 * 
 */
