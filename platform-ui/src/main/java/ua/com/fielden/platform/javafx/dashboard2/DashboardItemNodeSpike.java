...
public class DashboardItemNodeSpike extends Application {
    ...
    public void start(final Stage stage) throws MalformedURLException {
        ...
        final SentinelModel model = new SentinelModel(new IDescGetter() {
            public String desc() {
                return "1";
            }
        }, new IDescGetter() {
    ...
    private Group createDashboardNode() {
        ...
        final SentinelModel model = new SentinelModel(new IDescGetter() {
            public String desc() {
                return "Estimate > Budget by 20%";
            }
        }, new IDescGetter() {
            public String desc() {
                return "Estimate > Budget by 10%";
            }
        }, new IDescGetter() {
            public String desc() {
                return "Estimate does not exceed Budget by more than 10% -- normal situation";
            }
        });
