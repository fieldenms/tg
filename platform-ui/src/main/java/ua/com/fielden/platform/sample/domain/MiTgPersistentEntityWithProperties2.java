...
public class MiTgPersistentEntityWithProperties2 extends MiWithConfigurationSupport<TgPersistentEntityWithProperties> {
    ...
    public MiTgPersistentEntityWithProperties2(final TreeMenuWithTabs<?> treeMenu, final Injector injector, final ITreeMenuItemVisibilityProvider visibilityProvider) {
        super(caption, description, treeMenu, injector.getInstance(EntityCentreFactoryBinder.class), visibilityProvider, MiTgPersistentEntityWithProperties2.class, injector.getInstance(IGlobalDomainTreeManager.class));
    }
}