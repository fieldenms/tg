...
public class UndockableTreeMenuWithTabs<V extends BasePanel> extends TreeMenuWithTabs<V> {
    ...
    private Action createUndockSelectedTabSheetAction() {
        return new AbstractAction() {
            ...
            @Override
            public void actionPerformed(final ActionEvent e) {
                final TreeMenuItem<?> treeMenuItem = getTabPane().getSelectedComponent() instanceof BasePanel ? ((BasePanel) getTabPane().getSelectedComponent()).getAssociatedTreeMenuItem()
                        : null;
                if (treeMenuItem != null) {
                    activateItem(treeMenuItem, false);
                }
    ...
    /**
     * Activates the menu item based on menu item type and title. If the menu item is principle entity centre or any other menu item then title must be null, otherwise title must
     * be a name of non-principle entity centre.
     * 
     * @param menuItemClass
     * @param title
     * @return
    ...
    /**
     * Selects the menu item based on menu item type and title. If the menu item is principle entity centre or any other menu item then title must be null, otherwise title must be
     * a name of non-principle entity centre.
     * 
     * @param menuItemClass
     * @param title
     * @return
