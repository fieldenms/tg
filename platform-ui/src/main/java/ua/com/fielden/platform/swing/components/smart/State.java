...
import ua.com.fielden.platform.swing.components.smart.autocompleter.AutocompleterUi;
import ua.com.fielden.platform.swing.components.smart.autocompleter.OptionAutocompleterUi;
...
public enum State {
	...
	@Override
	public void ctrlAction(final OptionAutocompleterUi ui) {
	}
    },
    PROGRESS {
	@Override
     ...
     * @param ui
     */
    public abstract void ctrlAction(final OptionAutocompleterUi ui);
}
