...
/**
 * A checkbox UI control with property <code>editable</code>. This property ensures that while control is enabled its content cannot be changed. By default JCheckBox can only be
