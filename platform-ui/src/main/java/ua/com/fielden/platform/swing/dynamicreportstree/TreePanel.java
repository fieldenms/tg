...
/**
 * A panel for tree with filtering capabilities.
 *
 * @author TG Team
 *
 */
public class TreePanel extends JPanel {
    ...
    private static final long serialVersionUID = -6946441479361641574L;

    private final AbstractTree actionTree;

    private final JPanel search;

    private final FilterControl filterControl;

    public TreePanel(final AbstractTree dynamicReportTree) {
	super(new MigLayout("fill, insets 0", "[150::,grow,fill]", "[:30:][grow,fill]"));

	this.actionTree = dynamicReportTree;
	...
	// /////////////////////////////////////////////////////////////////////////////////////////
	final JButton jbExpandAll = new JButton(actionTree.getExpandAllAction());
	...
	final JButton jbCollapseAll = new JButton(actionTree.getCollapseAllAction());
	...
	final JButton jbCollapseAllExceptSelected = new JButton(actionTree.getCollapseAllExceptSelectedAction());
	...
	add(search, "wrap");
	final JScrollPane scroll = new JScrollPane(actionTree);
	...
	scroll.getViewport().addChangeListener(new ChangeListener() {
		...
		dynamicReportTree.viewPortChanged(event);
	    }
	});
	add(scroll);
     ...
     * @return
     */
    private Action createSelectItemAction(final AbstractTree reportTree, final IFilterableModel filterableModel) {
