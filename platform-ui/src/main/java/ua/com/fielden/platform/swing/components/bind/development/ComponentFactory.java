...
public class ComponentFactory {
    ...
    final String caption, //
            ...
            final String valueSeparator, final EditorCase editorCase) {
    ...
    public static <T extends Number> BoundedValidationLayer<JSpinner> createNumberSpinner(final IBindingEntity entity, final String propertyName, final boolean commitOnFocusLost, final String originalToolTipText, final T step, final IOnCommitAction... actions) {
        ...
        final Pair<Integer, Integer> minMax = Reflector.extractValidationLimits((AbstractEntity) entity, propertyName);
        if (minMax == null) {
        ...
        final Integer min = minMax.getKey() == null ? Integer.MIN_VALUE : minMax.getKey(), max = minMax.getValue() == null ? Integer.MAX_VALUE : minMax.getValue();
