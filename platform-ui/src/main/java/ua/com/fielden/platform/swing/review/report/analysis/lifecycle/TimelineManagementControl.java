...
public abstract class TimelineManagementControl<T extends AbstractEntity> implements ChartMouseListener, MouseListener, MouseMotionListener {
    ...
    private TimePeriod adjustPeriod(final TimePeriod oldPeriod, final ResizeMargin resizeMargin, final double difference) {
        ...
        return new SimpleTimePeriod(ResizeMargin.LEFT == resizeMargin || ResizeMargin.MIDDLE == resizeMargin ? adjust(oldLeft, duration * resizeRelationalValue) : oldLeft, ResizeMargin.RIGHT == resizeMargin
                || ResizeMargin.MIDDLE == resizeMargin ? adjust(oldRight, duration * resizeRelationalValue) : oldRight);
    }
