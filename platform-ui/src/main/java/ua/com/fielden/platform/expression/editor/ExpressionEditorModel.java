...
public class ExpressionEditorModel extends UModel<CalculatedProperty, CalculatedProperty, Object> {
     ...
     * 
     * @param entity
     *            - specific expression entity.
     * @param propertyBinder
     *            - appropriate property binder that binds entity.
     */
    ...
    /**
     * Determines the way the text will be inserted in to the editor. There are three ways: Apply, Append and Replace. The first type - Apply is used for functions like: YEAR(),
     * SUM(). The second type: Append is used for operators like: +, /. The Third type - Replace is used to replace selected text in the editor.
     * 
     * @author TG Team
     * 
     */
