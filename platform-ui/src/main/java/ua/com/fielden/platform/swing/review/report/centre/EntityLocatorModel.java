...
public class EntityLocatorModel<T extends AbstractEntity<?>> extends AbstractEntityCentreModel<T, ILocatorDomainTreeManagerAndEnhancer> {
    ...
    public EntityLocatorModel(final LocatorConfigurationModel<T, ?> configurationModel, final EntityInspectorModel<EntityQueryCriteria<ILocatorDomainTreeManagerAndEnhancer, T, IEntityDao<T>>> entityInspectorModel, final String name) {
