...
public class WebMap extends Application {
	...
	searchBox./*rawT*/textProperty().addListener(new ChangeListener<String>() {
		...
		locationUpdateTimeline.getKeyFrames().add(new KeyFrame(new Duration(400), new EventHandler<ActionEvent>() {
			...
			webEngine.executeScript("document.goToLocation(\"" + searchBox.getText() /*RawT*/+ "\")");
		    }
		}));
	...
	toolBar.getItems().addAll(road, satellite, hybrid, terrain, createSpacer(), google, startSlider, endSlider, //yahoo, bing,
