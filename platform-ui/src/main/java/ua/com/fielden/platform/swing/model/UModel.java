...
public abstract class UModel<M extends AbstractEntity<?>, D extends AbstractEntity<?>, C> implements ICloseGuard, IOpenGuard {
    ...
    /**
     * A convenient method for locking/unlocking blocking layer if it was provided. If the layer was not provided then nothing happens. This method should be invoked on EDT.
     * 
     * @param lock
     */
    ...
    /**
     * A convenient method for setting a message text for the blocking layer if it was provided. If the layer was not provided then nothing happens. This method should be invoked
     * on EDT.
     * 
     * @param lock
     */
