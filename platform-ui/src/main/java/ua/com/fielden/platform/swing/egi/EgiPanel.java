...
public class EgiPanel<T extends AbstractEntity<?>> extends JPanel {
    ...
    public EgiPanel(final Class<T> rootType, final ICentreDomainTreeManagerAndEnhancer cdtme, final IColouringScheme<T> egiColouringScheme) {
        ...
        final PropertyTableModel<?> _tableModel = egiColouringScheme == null ? createGridModel(managedType, gridDataModel.getKey())
                : createGridModelWithColouringScheme(managedType, gridDataModel.getKey(), egiColouringScheme);
