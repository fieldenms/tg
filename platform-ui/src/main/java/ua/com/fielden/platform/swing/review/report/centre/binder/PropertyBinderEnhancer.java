...
public class PropertyBinderEnhancer {
    ...
    /**
     * Returns the pair of entity type and list of properties. If the entityType parameter is an {@link EntityQueryCriteria} class then it returns pair of real entity type and
