...
/**
 * The default implementation of the {@link MultipleDimensionCubeModel}. Allows to create four types of multiple dimension cube: First creates multiple dimension cube with
 * hierarchical row and column. The other two create multiple dimension cube either with hierarchical row or column. And the fourth one creates empty multiple dimension cube model.
 * This model also allows to reset column and row models.
 * 
 * @author TG Team
 * 
 * @param <T>
...
public class DefaultMultipleDimensionCubeModel implements MultipleDimensionCubeModel {
    ...
    /**
     * Adds new column with specified identifier. If column with given identifier exists, then it will throw {@link IllegalArgumentException}.
     * 
     * @param identifier
     */
    ...
    /**
     * Adds new column with specified identifier at position index. If column with given identifier exists, then it will throw {@link IllegalArgumentException}.
     * 
     * @param identifier
     * @param index
     * @return
     ...
     * 
     * @param identifier
     *            - identifier of the column for which the name must be set.
     * @param name
     * @return
     */
     ...
     * 
     * @param identifier
     *            - identifier of the column for which the tool tip must be set.
     * @param toolTip
     * @return
     */
     ...
     * 
     * @param identifier
     *            - identifier of the column for which the class must be set.
     * @param type
     * @return
     */
     ...
     * 
     * @param identifier
     * @param withRelatedInfo
     *            - determines whether to remove other information (e.a. name, tool tip and value type, value) related to the identifier.
     * @return
     */
