...
public class GridConfigurationPanel<T extends AbstractEntity> extends AbstractAnalysisConfigurationView<T, IAbstractAnalysisDomainTreeManager, GridAnalysisView<T>, AbstractWizardView<T>> {
