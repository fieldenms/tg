...
public abstract class AbstractEntityCentreDetailsClickAction
	<MASTER_TYPE extends AbstractEntity,
	 ...
	 MASTER_VIEW extends UvEntityCentre<MASTER_TYPE, ? extends IEntityDao<MASTER_TYPE>, ?, ?>> extends BlockingLayerCommand<MASTER_TYPE> {
    ...
    protected abstract DetailsDynamicEntityReview<DETAILS_TYPE, ? extends IEntityDao<DETAILS_TYPE>> getDetailsEntityReview(final MASTER_TYPE value);
    ...
    private static class BlockingProvider<MASTER_TYPE extends AbstractEntity,
	 DETAILS_TYPE extends AbstractEntity,
	 MASTER_VIEW extends UvEntityCentre<MASTER_TYPE, ? extends IEntityDao<MASTER_TYPE>, ?, ?>> implements IBlockingLayerProvider {
