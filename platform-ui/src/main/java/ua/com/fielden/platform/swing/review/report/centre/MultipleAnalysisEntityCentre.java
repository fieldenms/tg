...
public class MultipleAnalysisEntityCentre<T extends AbstractEntity<?>> extends AbstractEntityCentre<T, ICentreDomainTreeManagerAndEnhancer> {
    ...
    /**
     * Creates the {@link HierarchyListener} that determines when the component was shown and it's size was determined. Also if analysis components were also loaded then it fires
     * the load event.
     * 
     * @return
     */
    ...
    private PropertyChangeListener createAfterLoadSelectListener() {
        return new PropertyChangeListener() {
            ...
            public void propertyChange(final PropertyChangeEvent evt) {
                synchronized (MultipleAnalysisEntityCentre.this) {
                    if ("currentAnalysisConfigurationView".equals(evt.getPropertyName()) && !analysisSelected && wasAnalysisLoaded
                            && getCurrentAnalysisConfigurationView().getModel().getName().equals(getOwner().getAnalysisToSelect())) {
