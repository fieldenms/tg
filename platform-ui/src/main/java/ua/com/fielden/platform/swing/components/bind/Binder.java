...
public final class Binder {
    ...
    private static AutocompleterBufferedPropertyWrapper createCommitOnFocusLostAutocompleterModel(final IBindingEntity entity, final String propertyName, final BoundedValidationLayer<AutocompleterTextFieldLayer> autocompleterValidationLayer, final boolean stringBinding, final IOnCommitAction... actions) {
	// The new instance of the trigger creates for every onFocusLostComponent! It provided for correct external commit action, using method BoundedValidationLayer.commit()
     ...
     * @param propertyName
     */
    protected static void bindOnFocusLostAutocompleter(final BoundedValidationLayer<AutocompleterTextFieldLayer> autocompleterValidationLayer, final IBindingEntity entity, final String propertyName, final boolean stringBinding, final String originalToolTipText, // final boolean manuallyComittable,
