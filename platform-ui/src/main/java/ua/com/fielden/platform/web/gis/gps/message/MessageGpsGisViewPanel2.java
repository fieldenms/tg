...
import ua.com.fielden.platform.web.gis.gps.GpsGisViewPanel2;

public class MessageGpsGisViewPanel2<T extends AbstractEntity<?>> extends GpsGisViewPanel2<T> {
    private static final long serialVersionUID = -7032805070573512539L;

    public MessageGpsGisViewPanel2(final MessageGpsGridAnalysisView2<T> parentView, final EntityGridInspector egi, final ListSelectionModel listSelectionModel, final PageHolder pageHolder) {
