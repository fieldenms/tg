...
public class TgPublishedYearlyMasterFrame extends BaseFrame {
    ...
    public TgPublishedYearlyMasterFrame(//
        ...
        model = new TgPublishedYearlyMasterModel(entityProducer, cache, entityObject, companionObject, valueMatcherFactory, owner, new FrameTitleUpdater(this), masterManager, criteriaGenerator);
