 ...
 */
@KeyType(Long.class)
@KeyTitle(value = "advice", desc = "advice description")
@DescTitle(value = "advice description", desc = "advice description")
public class Advice extends AbstractEntity<Long> {
    private static final long serialVersionUID = 1L;

    @IsProperty(AdvicePosition.class)
    private final List<AdvicePosition> positions = new ArrayList<AdvicePosition>();
    @IsProperty
    @Title(value="Date Raised", desc="Date Raised (hint)")
    private Date dateRaised;
    @IsProperty
    @Title(value="Date Dispatched", desc="Date Dispatched (hint)")
     ...
     */
    @IsProperty
    @Title(value="Disp. to Workshop", desc="Workshop this advice was dispatched to")
    private Workshop dispatchedToWorkshop;
    @IsProperty
    private boolean road = false;
    @IsProperty
    @Title(value="Carrier", desc="Wagon carrier")
