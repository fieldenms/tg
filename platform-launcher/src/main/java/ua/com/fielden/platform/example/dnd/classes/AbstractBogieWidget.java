...
/**
 * <code>AbstractBogieWidget</code> provides implementation of the graphical widget representing a bogie. It does not support any actions and features -- strictly visual
...
public abstract class AbstractBogieWidget<T extends AbstractWheelsetWidget> extends GenericSlotContainerNodeExtender<T> implements RotableContainerRetriever, IDecorable {
    ...
    /**
     * A convenience constructor for cases where there is no need for a mouse click event handler, but the default orientation is not appropriate.
     * 
     * @param caption
     */
    ...
    /**
     * A convenience constructor for cases where there is a need for a mouse click event handler, and the default orientation is appropriate.
     * 
     * @param caption
     */
    ...
    /**
     * A convenience constructor for cases where the default vertical orientation is appropriate, and there is no need to a mouse click event handler.
     * 
     * @param caption
     */
