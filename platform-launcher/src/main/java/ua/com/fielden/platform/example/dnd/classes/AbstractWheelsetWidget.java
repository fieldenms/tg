...
/**
 * <code>AbstractWheelsetWidget</code> provides implementation of the graphical
 * widget representing a wheelset. It does not support any actions and features
 * -- strictly visual representation.
 * 
 * @author 01es
 */
public abstract class AbstractWheelsetWidget extends AbstractNode implements IDraggable, IDecorable, RotableContainerRetriever {
    ...
    /**
     * A convenience constructor for cases where there is no need to provide
    ...
    /**
     * A convenience constructor for cases where there is a need to provide
     * mouse click event handler, and the default vertical orientation is
     * appropriate.
     * 
     * @param caption
     * @param orientation
