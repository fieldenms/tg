...
public class MiSimpleECEEntity extends MiWithConfigurationSupport<SimpleECEEntity> {
	...
	super("Simple entity", "Simple entity description", injector, treeMenu, new StubEntityCentreFactory<SimpleECEEntity>(), visibilityProvider, MiSimpleECEEntity.class);
    }
