...
public class PopulateDb extends DomainDrivenDataPopulation {
	...
	save(new_(SimpleCompositeEntity.class, sentity1, "COMPLEX1").setInitDate(date("2008-01-01 00:00:00")).setActive(true).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity1, "COMPLEX2").setInitDate(date("2008-01-02 00:00:00")).setActive(false).setNumValue(Integer.valueOf(130)));
	save(new_(SimpleCompositeEntity.class, sentity2, "COMPLEX1").setInitDate(date("2008-01-03 00:00:00")).setActive(true).setNumValue(Integer.valueOf(104)));
	save(new_(SimpleCompositeEntity.class, sentity2, "COMPLEX2").setInitDate(date("2008-01-04 00:00:00")).setActive(true).setNumValue(Integer.valueOf(105)));
	save(new_(SimpleCompositeEntity.class, sentity3, "COMPLEX1").setInitDate(date("2008-01-05 00:00:00")).setActive(false).setNumValue(Integer.valueOf(150)));
	save(new_(SimpleCompositeEntity.class, sentity3, "COMPLEX2").setInitDate(date("2008-01-06 00:00:00")).setActive(false).setNumValue(Integer.valueOf(140)));
	save(new_(SimpleCompositeEntity.class, sentity4, "COMPLEX1").setInitDate(date("2008-01-07 00:00:00")).setActive(true).setNumValue(Integer.valueOf(101)));
	save(new_(SimpleCompositeEntity.class, sentity4, "COMPLEX2").setInitDate(date("2008-01-08 00:00:00")).setActive(true).setNumValue(Integer.valueOf(103)));
	save(new_(SimpleCompositeEntity.class, sentity5, "COMPLEX1").setInitDate(date("2008-01-09 00:00:00")).setActive(false).setNumValue(Integer.valueOf(120)));
	save(new_(SimpleCompositeEntity.class, sentity5, "COMPLEX2").setInitDate(date("2008-01-10 00:00:00")).setActive(true).setNumValue(Integer.valueOf(103)));
	save(new_(SimpleCompositeEntity.class, sentity6, "COMPLEX1").setInitDate(date("2008-01-11 00:00:00")).setActive(false).setNumValue(Integer.valueOf(130)));
	save(new_(SimpleCompositeEntity.class, sentity6, "COMPLEX2").setInitDate(date("2008-01-12 00:00:00")).setActive(true).setNumValue(Integer.valueOf(50)));
	save(new_(SimpleCompositeEntity.class, sentity7, "COMPLEX1").setInitDate(date("2008-01-13 00:00:00")).setActive(true).setNumValue(Integer.valueOf(60)));
	save(new_(SimpleCompositeEntity.class, sentity7, "COMPLEX2").setInitDate(date("2008-01-14 00:00:00")).setActive(false).setNumValue(Integer.valueOf(410)));
	save(new_(SimpleCompositeEntity.class, sentity8, "COMPLEX1").setInitDate(date("2008-01-15 00:00:00")).setActive(false).setNumValue(Integer.valueOf(150)));
	save(new_(SimpleCompositeEntity.class, sentity8, "COMPLEX2").setInitDate(date("2008-01-16 00:00:00")).setActive(true).setNumValue(Integer.valueOf(106)));
	save(new_(SimpleCompositeEntity.class, sentity9, "COMPLEX1").setInitDate(date("2008-01-17 00:00:00")).setActive(true).setNumValue(Integer.valueOf(108)));
	save(new_(SimpleCompositeEntity.class, sentity9, "COMPLEX2").setInitDate(date("2008-01-18 00:00:00")).setActive(false).setNumValue(Integer.valueOf(150)));
	save(new_(SimpleCompositeEntity.class, sentity10, "COMPLEX1").setInitDate(date("2008-01-19 00:00:00")).setActive(false).setNumValue(Integer.valueOf(610)));
	save(new_(SimpleCompositeEntity.class, sentity10, "COMPLEX2").setInitDate(date("2008-01-20 00:00:00")).setActive(true).setNumValue(Integer.valueOf(180)));
	save(new_(SimpleCompositeEntity.class, sentity11, "COMPLEX1").setInitDate(date("2008-02-01 00:00:00")).setActive(false).setNumValue(Integer.valueOf(1)));
	save(new_(SimpleCompositeEntity.class, sentity11, "COMPLEX2").setInitDate(date("2008-02-02 00:00:00")).setActive(true).setNumValue(Integer.valueOf(1)));
	save(new_(SimpleCompositeEntity.class, sentity12, "COMPLEX1").setInitDate(date("2008-02-03 00:00:00")).setActive(false).setNumValue(Integer.valueOf(140)));
	save(new_(SimpleCompositeEntity.class, sentity12, "COMPLEX2").setInitDate(date("2008-02-04 00:00:00")).setActive(false).setNumValue(Integer.valueOf(140)));
	save(new_(SimpleCompositeEntity.class, sentity13, "COMPLEX1").setInitDate(date("2008-02-05 00:00:00")).setActive(true).setNumValue(Integer.valueOf(105)));
	save(new_(SimpleCompositeEntity.class, sentity13, "COMPLEX2").setInitDate(date("2008-02-06 00:00:00")).setActive(false).setNumValue(Integer.valueOf(105)));
	save(new_(SimpleCompositeEntity.class, sentity14, "COMPLEX1").setInitDate(date("2008-02-07 00:00:00")).setActive(true).setNumValue(Integer.valueOf(60)));
	save(new_(SimpleCompositeEntity.class, sentity14, "COMPLEX2").setInitDate(date("2008-02-08 00:00:00")).setActive(true).setNumValue(Integer.valueOf(70)));
	save(new_(SimpleCompositeEntity.class, sentity15, "COMPLEX1").setInitDate(date("2008-02-09 00:00:00")).setActive(false).setNumValue(Integer.valueOf(40)));
	save(new_(SimpleCompositeEntity.class, sentity15, "COMPLEX2").setInitDate(date("2008-02-10 00:00:00")).setActive(true).setNumValue(Integer.valueOf(106)));
	save(new_(SimpleCompositeEntity.class, sentity16, "COMPLEX1").setInitDate(date("2008-02-11 00:00:00")).setActive(false).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity16, "COMPLEX2").setInitDate(date("2008-02-12 00:00:00")).setActive(true).setNumValue(Integer.valueOf(210)));
	save(new_(SimpleCompositeEntity.class, sentity17, "COMPLEX1").setInitDate(date("2008-02-13 00:00:00")).setActive(false).setNumValue(Integer.valueOf(210)));
	save(new_(SimpleCompositeEntity.class, sentity17, "COMPLEX2").setInitDate(date("2008-02-14 00:00:00")).setActive(true).setNumValue(Integer.valueOf(104)));
	save(new_(SimpleCompositeEntity.class, sentity18, "COMPLEX1").setInitDate(date("2008-02-15 00:00:00")).setActive(false).setNumValue(Integer.valueOf(104)));
	save(new_(SimpleCompositeEntity.class, sentity18, "COMPLEX2").setInitDate(date("2008-02-16 00:00:00")).setActive(false).setNumValue(Integer.valueOf(106)));
	save(new_(SimpleCompositeEntity.class, sentity19, "COMPLEX1").setInitDate(date("2008-02-17 00:00:00")).setActive(true).setNumValue(Integer.valueOf(170)));
	save(new_(SimpleCompositeEntity.class, sentity19, "COMPLEX2").setInitDate(date("2008-02-18 00:00:00")).setActive(true).setNumValue(Integer.valueOf(107)));
	save(new_(SimpleCompositeEntity.class, sentity20, "COMPLEX1").setInitDate(date("2008-02-19 00:00:00")).setActive(true).setNumValue(Integer.valueOf(106)));
	save(new_(SimpleCompositeEntity.class, sentity20, "COMPLEX2").setInitDate(date("2008-02-20 00:00:00")).setActive(false).setNumValue(Integer.valueOf(105)));
	save(new_(SimpleCompositeEntity.class, sentity21, "COMPLEX1").setInitDate(date("2008-03-01 00:00:00")).setActive(true).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity21, "COMPLEX2").setInitDate(date("2008-03-02 00:00:00")).setActive(true).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity22, "COMPLEX1").setInitDate(date("2008-03-03 00:00:00")).setActive(false).setNumValue(Integer.valueOf(104)));
	save(new_(SimpleCompositeEntity.class, sentity22, "COMPLEX2").setInitDate(date("2008-03-04 00:00:00")).setActive(true).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity23, "COMPLEX1").setInitDate(date("2008-03-05 00:00:00")).setActive(false).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity23, "COMPLEX2").setInitDate(date("2008-03-06 00:00:00")).setActive(true).setNumValue(Integer.valueOf(106)));
	save(new_(SimpleCompositeEntity.class, sentity24, "COMPLEX1").setInitDate(date("2008-03-07 00:00:00")).setActive(false).setNumValue(Integer.valueOf(107)));
	save(new_(SimpleCompositeEntity.class, sentity24, "COMPLEX2").setInitDate(date("2008-03-08 00:00:00")).setActive(true).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity25, "COMPLEX1").setInitDate(date("2008-03-09 00:00:00")).setActive(true).setNumValue(Integer.valueOf(120)));
	save(new_(SimpleCompositeEntity.class, sentity25, "COMPLEX2").setInitDate(date("2008-03-10 00:00:00")).setActive(false).setNumValue(Integer.valueOf(1650)));
	save(new_(SimpleCompositeEntity.class, sentity26, "COMPLEX1").setInitDate(date("2010-01-01 00:00:00")).setActive(true).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity26, "COMPLEX2").setInitDate(date("2010-01-02 00:00:00")).setActive(false).setNumValue(Integer.valueOf(410)));
	save(new_(SimpleCompositeEntity.class, sentity27, "COMPLEX1").setInitDate(date("2010-01-03 00:00:00")).setActive(true).setNumValue(Integer.valueOf(140)));
	save(new_(SimpleCompositeEntity.class, sentity27, "COMPLEX2").setInitDate(date("2010-01-04 00:00:00")).setActive(false).setNumValue(Integer.valueOf(310)));
	save(new_(SimpleCompositeEntity.class, sentity28, "COMPLEX1").setInitDate(date("2010-01-05 00:00:00")).setActive(true).setNumValue(Integer.valueOf(103)));
	save(new_(SimpleCompositeEntity.class, sentity28, "COMPLEX2").setInitDate(date("2010-01-06 00:00:00")).setActive(false).setNumValue(Integer.valueOf(103)));
	save(new_(SimpleCompositeEntity.class, sentity29, "COMPLEX1").setInitDate(date("2010-01-07 00:00:00")).setActive(true).setNumValue(Integer.valueOf(104)));
	save(new_(SimpleCompositeEntity.class, sentity29, "COMPLEX2").setInitDate(date("2010-01-08 00:00:00")).setActive(true).setNumValue(Integer.valueOf(17)));
	save(new_(SimpleCompositeEntity.class, sentity30, "COMPLEX1").setInitDate(date("2010-01-09 00:00:00")).setActive(true).setNumValue(Integer.valueOf(108)));
	save(new_(SimpleCompositeEntity.class, sentity30, "COMPLEX2").setInitDate(date("2010-01-10 00:00:00")).setActive(false).setNumValue(Integer.valueOf(103)));
	save(new_(SimpleCompositeEntity.class, sentity31, "COMPLEX1").setInitDate(date("2010-01-11 00:00:00")).setActive(false).setNumValue(Integer.valueOf(13)));
	save(new_(SimpleCompositeEntity.class, sentity31, "COMPLEX2").setInitDate(date("2010-01-12 00:00:00")).setActive(true).setNumValue(Integer.valueOf(143)));
	save(new_(SimpleCompositeEntity.class, sentity32, "COMPLEX1").setInitDate(date("2010-01-13 00:00:00")).setActive(false).setNumValue(Integer.valueOf(145)));
	save(new_(SimpleCompositeEntity.class, sentity32, "COMPLEX2").setInitDate(date("2010-01-14 00:00:00")).setActive(false).setNumValue(Integer.valueOf(107)));
	save(new_(SimpleCompositeEntity.class, sentity33, "COMPLEX1").setInitDate(date("2010-01-15 00:00:00")).setActive(false).setNumValue(Integer.valueOf(167)));
	save(new_(SimpleCompositeEntity.class, sentity33, "COMPLEX2").setInitDate(date("2010-01-16 00:00:00")).setActive(true).setNumValue(Integer.valueOf(189)));
	save(new_(SimpleCompositeEntity.class, sentity34, "COMPLEX1").setInitDate(date("2010-01-17 00:00:00")).setActive(false).setNumValue(Integer.valueOf(112)));
	save(new_(SimpleCompositeEntity.class, sentity34, "COMPLEX2").setInitDate(date("2010-01-18 00:00:00")).setActive(true).setNumValue(Integer.valueOf(143)));
	save(new_(SimpleCompositeEntity.class, sentity35, "COMPLEX1").setInitDate(date("2010-01-19 00:00:00")).setActive(false).setNumValue(Integer.valueOf(153)));
	save(new_(SimpleCompositeEntity.class, sentity35, "COMPLEX2").setInitDate(date("2010-01-20 00:00:00")).setActive(true).setNumValue(Integer.valueOf(107)));
	save(new_(SimpleCompositeEntity.class, sentity36, "COMPLEX1").setInitDate(date("2010-02-01 00:00:00")).setActive(true).setNumValue(Integer.valueOf(10)));
	save(new_(SimpleCompositeEntity.class, sentity36, "COMPLEX2").setInitDate(date("2010-02-02 00:00:00")).setActive(true).setNumValue(Integer.valueOf(17)));
	save(new_(SimpleCompositeEntity.class, sentity37, "COMPLEX1").setInitDate(date("2010-02-03 00:00:00")).setActive(false).setNumValue(Integer.valueOf(16)));
	save(new_(SimpleCompositeEntity.class, sentity37, "COMPLEX2").setInitDate(date("2010-02-04 00:00:00")).setActive(true).setNumValue(Integer.valueOf(18)));
	save(new_(SimpleCompositeEntity.class, sentity38, "COMPLEX1").setInitDate(date("2010-02-05 00:00:00")).setActive(false).setNumValue(Integer.valueOf(145)));
	save(new_(SimpleCompositeEntity.class, sentity38, "COMPLEX2").setInitDate(date("2010-02-06 00:00:00")).setActive(true).setNumValue(Integer.valueOf(234)));
	save(new_(SimpleCompositeEntity.class, sentity39, "COMPLEX1").setInitDate(date("2010-02-07 00:00:00")).setActive(true).setNumValue(Integer.valueOf(482)));
	save(new_(SimpleCompositeEntity.class, sentity39, "COMPLEX2").setInitDate(date("2010-02-08 00:00:00")).setActive(false).setNumValue(Integer.valueOf(256)));
	save(new_(SimpleCompositeEntity.class, sentity40, "COMPLEX1").setInitDate(date("2010-02-09 00:00:00")).setActive(true).setNumValue(Integer.valueOf(53)));
	save(new_(SimpleCompositeEntity.class, sentity40, "COMPLEX2").setInitDate(date("2010-02-10 00:00:00")).setActive(true).setNumValue(Integer.valueOf(76)));
	save(new_(SimpleCompositeEntity.class, sentity41, "COMPLEX1").setInitDate(date("2010-02-11 00:00:00")).setActive(true).setNumValue(Integer.valueOf(56)));
	save(new_(SimpleCompositeEntity.class, sentity41, "COMPLEX2").setInitDate(date("2010-02-12 00:00:00")).setActive(false).setNumValue(Integer.valueOf(23)));
	save(new_(SimpleCompositeEntity.class, sentity42, "COMPLEX1").setInitDate(date("2010-02-13 00:00:00")).setActive(true).setNumValue(Integer.valueOf(67)));
	save(new_(SimpleCompositeEntity.class, sentity42, "COMPLEX2").setInitDate(date("2010-02-14 00:00:00")).setActive(false).setNumValue(Integer.valueOf(933)));
	save(new_(SimpleCompositeEntity.class, sentity43, "COMPLEX1").setInitDate(date("2010-02-15 00:00:00")).setActive(true).setNumValue(Integer.valueOf(836)));
	save(new_(SimpleCompositeEntity.class, sentity43, "COMPLEX2").setInitDate(date("2010-02-16 00:00:00")).setActive(true).setNumValue(Integer.valueOf(833)));
	save(new_(SimpleCompositeEntity.class, sentity44, "COMPLEX1").setInitDate(date("2010-02-17 00:00:00")).setActive(false).setNumValue(Integer.valueOf(8337)));
	save(new_(SimpleCompositeEntity.class, sentity44, "COMPLEX2").setInitDate(date("2010-02-18 00:00:00")).setActive(false).setNumValue(Integer.valueOf(722)));
	save(new_(SimpleCompositeEntity.class, sentity45, "COMPLEX1").setInitDate(date("2010-02-19 00:00:00")).setActive(true).setNumValue(Integer.valueOf(468)));
	save(new_(SimpleCompositeEntity.class, sentity45, "COMPLEX2").setInitDate(date("2010-02-20 00:00:00")).setActive(true).setNumValue(Integer.valueOf(783)));
	save(new_(SimpleCompositeEntity.class, sentity46, "COMPLEX1").setInitDate(date("2010-03-01 00:00:00")).setActive(true).setNumValue(Integer.valueOf(13)));
	save(new_(SimpleCompositeEntity.class, sentity46, "COMPLEX2").setInitDate(date("2010-03-02 00:00:00")).setActive(false).setNumValue(Integer.valueOf(67)));
	save(new_(SimpleCompositeEntity.class, sentity47, "COMPLEX1").setInitDate(date("2010-03-03 00:00:00")).setActive(false).setNumValue(Integer.valueOf(93)));
	save(new_(SimpleCompositeEntity.class, sentity47, "COMPLEX2").setInitDate(date("2010-03-04 00:00:00")).setActive(true).setNumValue(Integer.valueOf(111)));
	save(new_(SimpleCompositeEntity.class, sentity48, "COMPLEX1").setInitDate(date("2010-03-05 00:00:00")).setActive(false).setNumValue(Integer.valueOf(126)));
	save(new_(SimpleCompositeEntity.class, sentity48, "COMPLEX2").setInitDate(date("2010-03-06 00:00:00")).setActive(false).setNumValue(Integer.valueOf(167)));
	save(new_(SimpleCompositeEntity.class, sentity49, "COMPLEX1").setInitDate(date("2010-03-07 00:00:00")).setActive(true).setNumValue(Integer.valueOf(783)));
	save(new_(SimpleCompositeEntity.class, sentity49, "COMPLEX2").setInitDate(date("2010-03-08 00:00:00")).setActive(false).setNumValue(Integer.valueOf(672)));
	save(new_(SimpleCompositeEntity.class, sentity50, "COMPLEX1").setInitDate(date("2010-03-09 00:00:00")).setActive(false).setNumValue(Integer.valueOf(788)));
	save(new_(SimpleCompositeEntity.class, sentity50, "COMPLEX2").setInitDate(date("2010-03-10 00:00:00")).setActive(true).setNumValue(Integer.valueOf(75)));
    }
