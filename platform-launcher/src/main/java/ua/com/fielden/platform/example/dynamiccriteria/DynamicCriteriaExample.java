...
public class DynamicCriteriaExample extends AbstractUiApplication {
	...
	final Class entityClass = Bogie.class;
	...
	builderModel = new DynamicCriteriaModelBuilder(entityFactory, vmf, injector.getInstance(IDaoFactory.class), dao, injector.getInstance(IEntityAggregatesDao.class), entityClass, "resources/criterias/test.dcf", injector.getInstance(ICenterConfigurationController.class), null, entityReviewModelFactory);
	...
	new DynamicCriteriaExample().launch(args);
    }
