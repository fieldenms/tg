...
public class WorkOrderDataStore {
    ...
    static {
        ...
        data.add(new WorkOrderEntity().setKey("wo1")//
        .setDesc("wo1 desc")//
        ...
        .setJobNo("job1"));
        data.add(new WorkOrderEntity().setKey("wo2")//
        .setDesc("wo2 desc")//
        .setEarlyStart(null)//
        .setEarlyFinish(new DateTime(2013, 11, 18, 0, 0).toDate())//
        .setActualStart(new DateTime(2013, 11, 13, 0, 0).toDate())//
        ...
        .setWorkRequest(workRequest)//
        .setJobNo("job2"));
        data.add(new WorkOrderEntity().setKey("wo3")//
        .setDesc("wo3 desc")//
        .setEarlyStart(new DateTime(2013, 11, 11, 0, 0).toDate())//
        .setEarlyFinish(new DateTime(2013, 11, 18, 0, 0).toDate())//
        .setActualStart(null)//
        ...
        .setWorkRequest(workRequest)//
        .setJobNo("job3"));
        data.add(new WorkOrderEntity().setKey("wo4")//
        .setDesc("wo4 desc")//
        .setEarlyStart(null)//
        .setEarlyFinish(new DateTime(2013, 11, 18, 0, 0).toDate())//
        .setActualStart(null)//
        ...
        .setWorkRequest(workRequest)//
        .setJobNo("job4"));
        data.add(new WorkOrderEntity().setKey("wo5")//
        .setDesc("wo5 desc")//
        .setEarlyStart(new DateTime(2013, 11, 11, 0, 0).toDate())//
        .setEarlyFinish(new DateTime(2013, 11, 18, 0, 0).toDate())//
        .setActualStart(new DateTime(2013, 11, 13, 0, 0).toDate())//
        ...
        .setWorkRequest(workRequest)//
        .setJobNo("job5"));
        data.add(new WorkOrderEntity().setKey("wo6")//
        .setDesc("wo6 desc")//
        .setEarlyStart(new DateTime(2013, 11, 11, 0, 0).toDate())//
        .setEarlyFinish(null)//
        .setActualStart(new DateTime(2013, 11, 13, 0, 0).toDate())//
