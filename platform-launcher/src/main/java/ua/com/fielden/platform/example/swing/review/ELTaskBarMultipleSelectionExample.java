...
/**
 * Example application for the EntityLocator with criteria panel placed into the task bar panel and multiple selection.
 *
 * @author Oleh
 */
public class ELTaskBarMultipleSelectionExample extends AbstractUiApplication {
	...
	final EntityQueryCriteria<Wheelset, IWheelsetDao> criteria = entityFactory.newByKey(WheelsetQueryCriteria.class, "criteria")//
	.setValueMatcher("rotables", rotableValueMatcher)//
	...
	rotableReviewModel.setOrder("key", SortOrder.ASCENDING, true);
	rotableReviewModel.setOrder("rotableClass", SortOrder.ASCENDING, false);
    }
	...
	new ELTaskBarMultipleSelectionExample().launch(args);
    }
