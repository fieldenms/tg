 ...
 *
 */
public class EntityLocatorVerSplitterExample extends AbstractUiApplication {
	...
	.addReadonly("key", "No")//
	.addReadonly("desc", "Description")//
	.addReadonly("status", "Status")//
	.addReadonly("rotableClass", "Class");
	...
	final EntityLocatorVerSplitter rotableLocator = new EntityLocatorVerSplitter(rotableReviewModel, true);
	rotableLocator.setPreferredSize(new Dimension(600, 800));
	SimpleLauncher.show("Entity locator example", rotableLocator);
    }

    public static void main(final String[] args) {
	new EntityLocatorVerSplitterExample().launch(args);
    }
