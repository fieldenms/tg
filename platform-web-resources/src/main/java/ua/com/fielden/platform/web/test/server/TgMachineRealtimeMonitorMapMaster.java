...
/**
 * An entity master that represents a chart for {@link TgMachineRealtimeMonitorMapMaster}.
 *
 * @author TG Team
 *
 * @param <T>
 */
public class TgMachineRealtimeMonitorMapMaster implements IMaster<TgMachineRealtimeMonitorMap> {
    ...
    public TgMachineRealtimeMonitorMapMaster() {
        ...
        final DomElement tgMachineRealtimeMonitorMap = new DomElement("tg-map")
                .clazz("tg-map")
        ...
        final String entityMasterStr = ResourceLoader.getText("ua/com/fielden/platform/web/master/tg-entity-master-template.html")
                ...
                .replace("@entity_type", TgMachineRealtimeMonitorMap.class.getSimpleName())
                .replace("<!--@tg-entity-master-content-->", tgMachineRealtimeMonitorMap.toString())
                ...
                .replace("//@attached-callback", "self.classList.remove('canLeave'); "
                        + "new L.GIS.RealtimeMonitorGisComponent(self.querySelector('.map'), self.querySelector('.progress'), self.querySelector('.progress-bar'), self.querySelector('.tg-map'));")
    ...
    @Override
    public Optional<Class<? extends IValueMatcherWithContext<TgMachineRealtimeMonitorMap, ?>>> matcherTypeFor(final String propName) {
