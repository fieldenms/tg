...
public class ContextMatcher extends AbstractSearchEntityByKeyWithContext<TgPersistentEntityWithProperties, TgPersistentEntityWithProperties> {
    ...
    @Override
    protected EntityResultQueryModel<TgPersistentEntityWithProperties> completeEqlBasedOnContext(final TgPersistentEntityWithProperties context, final ICompoundCondition0<TgPersistentEntityWithProperties> incompleteEql) {
