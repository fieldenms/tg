...
public class WebUiPreferencesResource extends AbstractWebResource {
    ...
    public WebUiPreferencesResource(final IWebResourceLoader webResourceLoader, final IDeviceProvider deviceProvider, final IUniversalConstants universalConstants, final Context context, final Request request, final Response response) {
