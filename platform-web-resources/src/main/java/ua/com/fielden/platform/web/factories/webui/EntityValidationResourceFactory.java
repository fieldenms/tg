...
public class EntityValidationResourceFactory extends Restlet {
     ...
     * @param injector
     */
    public EntityValidationResourceFactory(final List<EntityMaster<? extends AbstractEntity<?>>> masters, final Injector injector) {
