 ...
 * <p>
 * This implementation assumes that non-group menu item type has a constructor with four parameters ({@link TreeMenuWithTabs}, {@link Injector},
 * {@link ITreeMenuItemVisibilityProvider}) and the group menu items (i.e. derived from {@link MiGroupItem}) have the constructor with a single parameter of type
 * {@link ITreeMenuItemVisibilityProvider}.
 * 
 * @author TG Team
 * 
 */
