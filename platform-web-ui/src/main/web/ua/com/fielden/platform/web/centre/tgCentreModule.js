define(['log', 'angular', 'angular.resource'], function(log, angular, angularResource) {
	var tgCentreModule = angular.module('tgCentreModule', ['ngResource']);

	tgCentreModule.factory("CentreEntity", function($resource) {
		return $resource("users/SU/centre/:centreName");
	});

	tgCentreModule.factory("QueryRunner", function($resource) {
	...
	tgCentreModule.controller("CentreController", ["$scope", "$routeParams", "centre", "QueryRunner",
	...
	tgCentreModule.directive('tgSelectionCriteria', function($compile) {
	...
	tgCentreModule.directive("tgEditor", function($compile) {
