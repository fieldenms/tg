...
Polymer({
    ...
    _calcBackgroundRenderingHintsStyle: function(renderingHints, column) {
        let style = "";
        let rendHints = (column && column.property && renderingHints && renderingHints[column.property]) || {};
    ...
    _calcValueRenderingHintsStyle: function (renderingHints, column, isBoolean) {
        ...
        let rendHints = (column && column.property && renderingHints && renderingHints[column.property] && renderingHints[column.property].valueStyles) || {};
        for (let property in rendHints) {
            if (rendHints.hasOwnProperty(property)) {
                style += " " + property + ": " + rendHints[property] + ";";
            }
    ...
    _isBooleanProp: function (hostComponent, entity, column) {
        return hostComponent && column && column.property && column.type && entity && hostComponent.isBooleanProp(entity, column.property, column.type);
    },
    ...
    _isHyperlinkProp: function (hostComponent, entity, column) {
        return hostComponent && column && column.property && column.type && entity && hostComponent.isHyperlinkProp(entity, column.property, column.type);
    },
    ...
    _isNotBooleanOrHyperlinkProp: function (hostComponent, entity, column) {
        return hostComponent && column && column.property && column.type && entity && hostComponent.isNotBooleanOrHyperlinkProp(entity, column.property, column.type);
    },
    ...
    _getValueFromEntity: function (hostComponent, entity, column) {
        return hostComponent && column && column.property && entity && hostComponent.getValueFromEntity(entity, column.property);
    },

    _getBindedValue: function (hostComponent, entity, column) {
        return hostComponent && column && column.property && column.type && entity && hostComponent.getBindedValue(entity, column.property, column.type);
    },
    /**
    ...
    _getValue: function (hostComponent, entity, column) {
        return hostComponent && column && column.property && column.type && entity && hostComponent.getValue(entity, column.property, column.type);
    },
});