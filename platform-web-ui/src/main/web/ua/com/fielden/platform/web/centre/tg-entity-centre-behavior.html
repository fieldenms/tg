    ...
    (function () {
        ...
        Polymer.TgBehaviors.TgEntityCentreBehaviorImpl = {
            ...
            _focusView: function (e, forward) {
                ...
                } else if (focusables.length === 0 || document.activeElement == focusables[lastIndex]) {
                    this.fire("tg-last-item-focused", {forward: forward, event: e});
                }
            },

            _getCurrentFocusableElements: function() {
                const _componentsToFocus = Array.from(this.querySelectorAll(FOCUSABLE_ELEMENTS_SELECTOR));
