...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
function newSplice(e,t,i){return{index:e,removed:t,addedCount:i}}"interactive"===document.readyState||"complete"===document.readyState?resolve():window.addEventListener("DOMContentLoaded",resolve);const EDIT_LEAVE=0,EDIT_UPDATE=1,EDIT_ADD=2,EDIT_DELETE=3;function calcEditDistances(e,t,i,n,r,a){let s=a-r+1,o=i-t+1,l=new Array(s);for(let e=0;e<s;e++)l[e]=new Array(o),l[e][0]=e;for(let e=0;e<o;e++)l[0][e]=e;for(let i=1;i<s;i++)for(let a=1;a<o;a++)if(equals(e[t+a-1],n[r+i-1]))l[i][a]=l[i-1][a-1];else{let e=l[i-1][a]+1,t=l[i][a-1]+1;l[i][a]=e<t?e:t}return l}function spliceOperationsFromEditDistances(e){let t=e.length-1,i=e[0].length-1,n=e[t][i],r=[];for(;t>0||i>0;){if(0==t){r.push(2),i--;continue}if(0==i){r.push(3),t--;continue}let a,s=e[t-1][i-1],o=e[t-1][i],l=e[t][i-1];a=o<l?o<s?o:s:l<s?l:s,a==s?(s==n?r.push(0):(r.push(1),n=s),t--,i--):a==o?(r.push(3),t--,n=o):(r.push(2),i--,n=l)}return r.reverse(),r}function calcSplices(e,t,i,n,r,a){let s,o=0,l=0,h=Math.min(i-t,a-r);if(0==t&&0==r&&(o=sharedPrefix(e,n,h)),i==e.length&&a==n.length&&(l=sharedSuffix(e,n,h-o)),r+=o,a-=l,(i-=l)-(t+=o)==0&&a-r==0)return[];if(t==i){for(s=newSplice(t,[],0);r<a;)s.removed.push(n[r++]);return[s]}if(r==a)return[newSplice(t,[],i-t)];let c=spliceOperationsFromEditDistances(calcEditDistances(e,t,i,n,r,a));s=void 0;let p=[],d=t,u=r;for(let e=0;e<c.length;e++)switch(c[e]){case 0:s&&(p.push(s),s=void 0),d++,u++;break;case 1:s||(s=newSplice(d,[],0)),s.addedCount++,d++,s.removed.push(n[u]),u++;break;case 2:s||(s=newSplice(d,[],0)),s.addedCount++,d++;break;case 3:s||(s=newSplice(d,[],0)),s.removed.push(n[u]),u++}return s&&p.push(s),p}function sharedPrefix(e,t,i){for(let n=0;n<i;n++)if(!equals(e[n],t[n]))return n;return i}function sharedSuffix(e,t,i){let n=e.length,r=t.length,a=0;for(;a<i&&equals(e[--n],t[--r]);)a++;return a}function calculateSplices(e,t){return calcSplices(e,0,e.length,t,0,t.length)}function equals(e,t){return e===t}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/function sameScope(e,t){return wrap(e).getRootNode()===t}function scopeSubtree(e,t=!1){if(!ShadyDOM$1||!ShadyCSS)return null;if(!ShadyDOM$1.handlesDynamicScoping)return null;const i=ShadyCSS.ScopingShim;if(!i)return null;const n=i.scopeForNode(e),r=wrap(e).getRootNode(),a=e=>{if(!sameScope(e,r))return;const t=Array.from(ShadyDOM$1.nativeMethods.querySelectorAll.call(e,"*"));t.push(e);for(let e=0;e<t.length;e++){const a=t[e];if(!sameScope(a,r))continue;const s=i.currentScopeForNode(a);s!==n&&(""!==s&&i.unscopeNode(a,s),i.scopeNode(a,n))}};if(a(e),t){const t=new MutationObserver((e=>{for(let t=0;t<e.length;t++){const i=e[t];for(let e=0;e<i.addedNodes.length;e++){const t=i.addedNodes[e];t.nodeType===Node.ELEMENT_NODE&&a(t)}}}));return t.observe(e,{childList:!0,subtree:!0}),t}return null}
/**
 * @fileoverview
 * @suppress {checkPrototypalTypes}
 * @license Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
function mutablePropertyChange(e,t,i,n,r){let a;r&&(a="object"==typeof i&&null!==i,a&&(n=e.__dataTemp[t]));let s=n!==i&&(n==n||i==i);return a&&s&&(e.__dataTemp[t]=i),s}Polymer.Class=Class;const MutableData=dedupingMixin((e=>class extends e{_shouldPropertyChange(e,t,i){return mutablePropertyChange(this,e,t,i,!0)}})),OptionalMutableData=dedupingMixin((e=>class extends e{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(e,t,i){return mutablePropertyChange(this,e,t,i,this.mutableData)}}));MutableData._mutablePropertyChange=mutablePropertyChange;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
</custom-style>`;template$a.setAttribute("style","display: none;"),document.head.appendChild(template$a.content);var style=document.createElement("style");style.textContent="[hidden] { display: none !important; }",document.head.appendChild(style);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
found at http://polymer.github.io/PATENTS.txt
*/
if(template$7.setAttribute("style","display: none;"),document.head.appendChild(template$7.content),!window.polymerSkipLoadingFontRoboto){const e=document.createElement("link");e.rel="stylesheet",e.type="text/css",e.crossOrigin="anonymous",e.href="https://fonts.googleapis.com/css?family=Roboto+Mono:400,700|Roboto:400,300,300italic,400italic,500,500italic,700,700italic",document.head.appendChild(e)}
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</custom-style>`;template$6.setAttribute("style","display: none;"),document.head.appendChild(template$6.content);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</dom-module>`;template$4.setAttribute("style","display: none;"),document.head.appendChild(template$4.content);
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
</iron-iconset-svg>`;document.head.appendChild(template$1.content),
/**
@license
Copyright (c) 2015 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at
...
Polymer({is:"paper-icon-button",_template:html`
    ...
    <iron-icon id="icon" src="[[src]]" icon="[[icon]]"
               alt$="[[alt]]"></iron-icon>
  `,hostAttributes:{role:"button",tabindex:"0"},behaviors:[PaperInkyFocusBehavior],registered:function(){this._template.setAttribute("strip-whitespace","")},properties:{src:{type:String},icon:{type:String},alt:{type:String,observer:"_altChanged"}},_altChanged:function(e,t){var i=this.getAttribute("aria-label");i&&t!=i||this.setAttribute("aria-label",e)}});const template=html`
    <style>
        :host {
            padding: 8px;
            @apply --layout-horizontal;
