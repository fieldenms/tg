...
const customLabelTemplate = html`
    <label style$="[[_calcLabelStyle(_editorKind, _disabled)]]"
        ...
        <iron-icon id="scanIcon" class="label-action" hidden$="[[!_canScan(hideQrCodeScanner, noLabelFloat, entity, propertyName)]]" icon="tg-icons:qrcode-scan" on-tap="_scanTap"></iron-icon>
    </label>`;
