...
const template = html`
    ...
    <tg-responsive-toolbar class="custom-responsive-toolbar editor-toolbar" disabled$="[[disabled]]">
        ...
        <iron-icon slot="entity-specific-action" style$="[[_getActionStyle()]]" class="entity-specific-action" icon="editor-icons:list-checkbox" action-title="Task list" tooltip-text="Task list" on-down="_stopMouseEvent" on-tap="_createTaskList"></iron-icon>
        <iron-icon slot="entity-specific-action" style$="[[_getActionStyle()]]" class="entity-specific-action" icon="editor-icons:header-1" action-title="Heading 1" tooltip-text="Header 1" on-down="_stopMouseEvent" on-tap="_applyHeader1"></iron-icon>
        <iron-icon slot="entity-specific-action" style$="[[_getActionStyle()]]" class="entity-specific-action" icon="editor-icons:header-2" action-title="Heading 2" tooltip-text="Header 2" on-down="_stopMouseEvent" on-tap="_applyHeader2"></iron-icon>
        <iron-icon slot="entity-specific-action" style$="[[_getActionStyle()]]" class="entity-specific-action" icon="editor-icons:header-3" action-title="Heading 3" tooltip-text="Header 3" on-down="_stopMouseEvent" on-tap="_applyHeader3"></iron-icon>
        <iron-icon slot="entity-specific-action" style$="[[_getActionStyle()]]" class="entity-specific-action" icon="icons:undo" action-title="Undo" tooltip-text="Undo, Ctrl+Z, &#x2318;+Z" on-down="_stopMouseEvent" on-tap="_undo"></iron-icon>
        <iron-icon slot="entity-specific-action" style$="[[_getActionStyle()]]" class="entity-specific-action" icon="icons:redo" action-title="Redo" tooltip-text="Redo, Ctrl+Y, &#x2318;+Y" on-down="_stopMouseEvent" on-tap="_redo"></iron-icon>
