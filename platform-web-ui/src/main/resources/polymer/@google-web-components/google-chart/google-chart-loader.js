...
var loaderPromise = new Promise(function (resolve, reject) {
  ...
  if (typeof google !== 'undefined' && google.charts && typeof google.charts.load === 'function') {
    ...
    var loaderScript = document.querySelector('script[src="https://www.gstatic.com/charts/loader.js"]');
...
Polymer({
  ...
  _loadPackageForType: function (type) {
    ...
    if (!chartData) {
      return Promise.reject('This chart type is not yet supported: ' + type);
    }
