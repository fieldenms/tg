 ...
 */
import { FormattingOptions } from './formatting.js';
export declare type ErrorLikeThing = Error & {
    parsedStack?: string[];
    description?: string;
    fileName?: string;
    lineNumber?: number;
...
export declare function normalize(error: ErrorLikeThing, prettyOptions: Partial<FormattingOptions>): ErrorLikeThing;
