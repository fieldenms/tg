import { Schema, Slice, Fragment, DOMParser, NodeRange, Node as Node$3, Mark as Mark$1 } from '../../../../prosemirror-model/dist/index.js';
import { EditorView, DecorationSet, Decoration } from '../../../../prosemirror-view/dist/index.js';
import { ReplaceAroundStep, canSplit, StepMap, liftTarget } from '../../../../prosemirror-transform/dist/index.js';
import { PluginKey, EditorState, TextSelection, Selection, Plugin, AllSelection, NodeSelection, SelectionRange } from '../../../../prosemirror-state/dist/index.js';
import { keymap } from '../../../../prosemirror-keymap/dist/index.js';
import { baseKeymap, chainCommands, joinForward, setBlockType, wrapIn, toggleMark as toggleMark$1, exitCode, deleteSelection, selectAll, newlineInCode } from '../../../../prosemirror-commands/dist/index.js';
import { InputRule, inputRules, undoInputRule } from '../../../../prosemirror-inputrules/dist/index.js';
import { history, undo, redo, undoDepth } from '../../../../prosemirror-history/dist/index.js';
