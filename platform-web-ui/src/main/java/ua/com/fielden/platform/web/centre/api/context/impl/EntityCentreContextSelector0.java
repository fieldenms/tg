...
class EntityCentreContextSelector0<T extends AbstractEntity<?>> implements IEntityCentreContextSelector0<T> {
    ...
    public EntityCentreContextSelector0(final boolean withChosenEntity, final boolean withCurrentEntity, final boolean withAllSelectedEntities) {
    ...
    public IEntityCentreContextSelector1<T> withSelectionCrit() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, true, false, null, empty(), empty());
    }

    @Override
    public IEntityCentreContextSelector2<T> withMasterEntity() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, false, true, null, empty(), empty());
    }
    ...
    public IEntityCentreContextSelectorDone<T> withComputation(final BiFunction<AbstractFunctionalEntityWithCentreContext<?>, CentreContext<AbstractEntity<?>, AbstractEntity<?>>, Object> computation) {
        ...
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, false, false, computation, empty(), empty());
    }
    ...
    public IExtendedEntityCentreContextWithFunctionSelector<T> extendWithInsertionPointContext(final Class<? extends AbstractFunctionalEntityWithCentreContext<?>> insertionPointFunctionalType, final CentreContextConfig contextForInsertionPoint) {
        ...
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, false, false, null, of(linkedMapOf(t2(insertionPointFunctionalType, contextForInsertionPoint))), empty());
    }
    ...
    public IExtendedEntityCentreContextWithFunctionSelector<T> extendWithParentCentreContext(final CentreContextConfig parentCentreContext) {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, false, false, null, empty(), ofNullable(parentCentreContext));
    }
