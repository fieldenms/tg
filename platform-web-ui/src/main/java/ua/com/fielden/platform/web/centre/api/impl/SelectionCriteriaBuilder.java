...
class SelectionCriteriaBuilder<T extends AbstractEntity<?>> implements ISelectionCritKindSelector<T> {
    ...
    public IMultiValueCritSelector<T> asMulti() {
        ...
        // "this" is a keyword, which can be safely skipped
    ...
    public ISingleValueCritSelector<T> asSingle() {
        // "this" is a keyword, which cannot be used for single-valued selection criteria
        if ("this".equals(builder.currSelectionCrit.get())) {
            throw new IllegalArgumentException("Entity itself (this) cannot be used as a single-valued criterion.");
        }
    ...
    public IRangeValueCritSelector<T> asRange() {
        // "this" is a keyword, which cannot be used for range-valued selection criteria
        if ("this".equals(builder.currSelectionCrit.get())) {
            throw new IllegalArgumentException("Entity itself (this) cannot be used as a range-valued criterion.");
        }
