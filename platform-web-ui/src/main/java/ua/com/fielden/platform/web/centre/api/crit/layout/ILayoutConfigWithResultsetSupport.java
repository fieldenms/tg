...
public interface ILayoutConfigWithResultsetSupport<T extends AbstractEntity<?>> extends ILayoutConfig<T>, IResultSetBuilder0HideEgi<T> {
    /**
     ...
     * @return
     */
    <G extends AbstractEntity<?> & WithCreatedByUser<G>> IResultSetBuilder0HideEgi<T> withGenerator(final Class<G> entityTypeToBeGenerated, final Class<? extends IGenerator<G>> generatorType);
}
