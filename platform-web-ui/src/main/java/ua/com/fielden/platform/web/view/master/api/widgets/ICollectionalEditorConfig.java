 ...
 * @param <T>
 */
public interface ICollectionalEditorConfig<T extends AbstractEntity<?>> extends ICollectionalEditorWithStaticOrder<T>, ISkipValidation<ICollectionalEditorWithStaticOrder<T>> {
}
