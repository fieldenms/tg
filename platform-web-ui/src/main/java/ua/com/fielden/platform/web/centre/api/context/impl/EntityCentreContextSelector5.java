...
class EntityCentreContextSelector5<T extends AbstractEntity<?>> implements IEntityCentreContextSelector5<T> {
    ...
    public EntityCentreContextSelector5(final boolean withChosenEntity, final boolean withSelectionCrit, final boolean withMasterEntity) {
    ...
    public IEntityCentreContextSelector4<T> withSelectionCrit() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, false, false, true, withMasterEntity, null, empty(), empty());
    }
