...
class SelectionCriteriaLayoutBuilder<T extends AbstractEntity<?>> extends ResultSetBuilder<T> implements ILayoutConfigWithResultsetSupport<T> {
    ...
    @Override
    public <G extends AbstractEntity<?> & WithCreatedByUser<G>> IResultSetBuilder0HideEgi<T> withGenerator(final Class<G> entityTypeToBeGenerated, final Class<? extends IGenerator<G>> generator) {
