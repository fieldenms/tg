...
public class WebUiBuilder implements IWebUiBuilder {
    ...
    public String genWebUiPrefComponent() {
        ...
        return ResourceLoader.getText("ua/com/fielden/platform/js/app/config/tg-app-config.js").
    ...
    public String getAppIndex(final IDates dates) {
        return ResourceLoader.getText("ua/com/fielden/platform/js/index.html")
