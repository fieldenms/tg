...
class EntityCentreContextSelector1_2_4_extender_function_done<T extends AbstractEntity<?>> implements IEntityCentreContextSelector1<T>, IEntityCentreContextSelector2<T>, IEntityCentreContextSelector4<T>, IEntityCentreContextSelectorDone<T> {
    ...
    public EntityCentreContextSelector1_2_4_extender_function_done(
            final boolean withChosenEntity, final boolean withCurrentEntity, final boolean withAllSelectedEntities,
    ...
    public IEntityCentreContextSelector6<T> withMasterEntity() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, withSelectionCrit, true, computation, of(relatedContexts), parentCentreContext);
    }

    @Override
    public IEntityCentreContextSelector6<T> withSelectionCrit() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, true, withMasterEntity, computation, of(relatedContexts), parentCentreContext);
    }

    @Override
    public IEntityCentreContextSelector1<T> withCurrentEntity() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, true, withAllSelectedEntities, withSelectionCrit, withMasterEntity, computation, of(relatedContexts), parentCentreContext);
    }

    @Override
    public IEntityCentreContextSelector1<T> withSelectedEntities() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, true, withSelectionCrit, withMasterEntity, computation, of(relatedContexts), parentCentreContext);
    }
    ...
    public IEntityCentreContextSelectorDone<T> withComputation(final BiFunction<AbstractFunctionalEntityWithCentreContext<?>, CentreContext<AbstractEntity<?>, AbstractEntity<?>>, Object> computation) {
        ...
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, withSelectionCrit, withMasterEntity, computation, of(relatedContexts), parentCentreContext);
    }
    ...
    public IExtendedEntityCentreContextWithFunctionSelector<T> extendWithParentCentreContext(final CentreContextConfig parentCentreContext) {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withChosenEntity, withCurrentEntity, withAllSelectedEntities, withSelectionCrit, withMasterEntity, computation, of(relatedContexts), ofNullable(parentCentreContext));
    }
