...
class EntityCentreContextSelector1_2_4_extender_function_done<T extends AbstractEntity<?>> implements IEntityCentreContextSelector1<T>, IEntityCentreContextSelector2<T>, IEntityCentreContextSelector4<T>, IEntityCentreContextSelectorDone<T> {
    ...
    public IEntityCentreContextSelector6<T> withMasterEntity() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withCurrentEntity, withAllSelectedEntities, withSelectionCrit, true, withChosenEntity, computation, of(relatedContexts), parentCentreContext);
    }

    @Override
    public IEntityCentreContextSelector6<T> withSelectionCrit() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withCurrentEntity, withAllSelectedEntities, true, withMasterEntity, withChosenEntity, computation, of(relatedContexts), parentCentreContext);
    }

    @Override
    public IEntityCentreContextSelector1<T> withCurrentEntity() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(true, withAllSelectedEntities, withSelectionCrit, withMasterEntity, withChosenEntity, computation, of(relatedContexts), parentCentreContext);
    }

    @Override
    public IEntityCentreContextSelector1<T> withSelectedEntities() {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withCurrentEntity, true, withSelectionCrit, withMasterEntity, withChosenEntity, computation, of(relatedContexts), parentCentreContext);
    }
    ...
    public IEntityCentreContextSelectorDone<T> withComputation(final BiFunction<AbstractFunctionalEntityWithCentreContext<?>, CentreContext<AbstractEntity<?>, AbstractEntity<?>>, Object> computation) {
        ...
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withCurrentEntity, withAllSelectedEntities, withSelectionCrit, withMasterEntity, withChosenEntity, computation, of(relatedContexts), parentCentreContext);
    }
    ...
    public IExtendedEntityCentreContextWithFunctionSelector<T> extendWithParentCentreContext(final CentreContextConfig parentCentreContext) {
        return new EntityCentreContextSelector1_2_4_extender_function_done<T>(withCurrentEntity, withAllSelectedEntities, withSelectionCrit, withMasterEntity, withChosenEntity, computation, of(relatedContexts), ofNullable(parentCentreContext));
    }
