...
public interface IRangeValueAssigner<V, T extends AbstractEntity<?>> {
    ...
    /**
     * Accepts an entity centre context and a property name that was used defining a corresponding selection criterion.
     * An entity centre context should always be the one associated with the <code>run</code> action on an corresponding entity centre.
     * <p>
