 ...
 * more generic nature such as <i>update status for all entities that match current selection criteria</i>, which is not limited only to the presented on the current page entities.
 *
 *
 * @author TG Team
 *
