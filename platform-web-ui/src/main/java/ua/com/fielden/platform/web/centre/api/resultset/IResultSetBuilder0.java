 ...
 * @param <T>
 */
public interface IResultSetBuilder0<T extends AbstractEntity<?>> extends IResultSetBuilder<T> {
     ...
     * @return
     */
    IResultSetBuilder<T> withAction(final EntityActionConfig actionConfig);
}
