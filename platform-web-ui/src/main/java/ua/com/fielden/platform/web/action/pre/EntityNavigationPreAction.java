...
public class EntityNavigationPreAction implements IPreAction {
    ...
    public JsCode build() {
        return new JsCode(String.format("%n"
                ...
                + "        if (master && action.savedRoute) {%n"
                + "            master.$.menu.defaultRoute = action.savedRoute;%n"
                + "            delete action.savedRoute;%n"
                + "        }%n"
                ...
                + "                    }%n"
                + "                    if (master.$.menu) {%n"
                + "                         if (!action.savedRoute) {%n"
                + "                             action.savedRoute = master.$.menu.defaultRoute;%n"
                + "                         }%n"
                + "                         master.$.menu.defaultRoute = master.$.menu.sectionRoute;%n"
                + "                    }%n"
