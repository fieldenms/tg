...
public class EntityNavigationPreAction implements IPreAction {
    ...
    public JsCode build() {
        return new JsCode(String.format("%n"
                ...
                + "        const entityIndex = this.$.egi.findFilteredEntityIndex(action.currentEntity());%n"
                + "        if (entityIndex >= 0) {%n"
                ...
                + "        const thisPageInd = this.$.egi.findFilteredEntityIndex(action.currentEntity());%n"
                + "        if (thisPageInd >= 0) {%n"
                + "            const firstEntity = action._findFirstEntity();%n"
                + "            return firstEntity && !this.$.egi._areEqual(firstEntity, action.currentEntity());%n"
                + "        }%n"
                ...
                + "            return lastEntity && !this.$.egi._areEqual(lastEntity, action.currentEntity());%n"
                + "        }%n"
                + "        return action._countActualEntities() > 0;%n"
                + "    }.bind(self);%n"
                ...
                + "        const thisPageInd = this.$.egi.findEntityIndex(action.currentEntity());%n"
