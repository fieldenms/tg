...
public class WebModel {
    ...
    /**
     * Returns a functional name of the logic which is covered by this {@link WebModel}. Typically
     * the web model should be named as with convention like "CustomFunctionalityWebModel".
     *
     * @return
     */
	...
	sb.append("define(['log'], function(log) { ");
	...
	sb.append("		" + angularModuleName() + ".controller(\"" + controllerName() + "\", [" + createListOfInjectablesWithQuotes() + ", function(" + createListOfInjectablesWithoutQuotes() + ") {"
