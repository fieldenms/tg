...
public interface IResultSetBuilder5CustomPropAssignment<T extends AbstractEntity<?>> extends IResultSetBuilder6RenderingCustomiser<T> {
    ...
    IResultSetBuilder6RenderingCustomiser<T> setCustomPropsValueAssignmentHandler(final Class<? extends ICustomPropsAssignmentHandler<? extends AbstractEntity<?>>> handler);
}
