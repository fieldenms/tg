...
public class EntityCentreContextSelectorTest {
    ...
    public void context_with_current_entity() {
       ...
       assertEquals(new CentreContextConfig(true, false, false, false, false, null, empty(), empty()), config);
    }

    @Test
    public void context_with_all_selected_entities() {
       final CentreContextConfig config = context().withSelectedEntities().build();
       assertEquals(new CentreContextConfig(false, true, false, false, false, null, empty(), empty()), config);
    }

    @Test
    public void context_with_selection_crit() {
       final CentreContextConfig config = context().withSelectionCrit().build();
       assertEquals(new CentreContextConfig(false, false, true, false, false, null, empty(), empty()), config);
    }

    @Test
    public void context_with_master_entity() {
       final CentreContextConfig config = context().withMasterEntity().build();
       assertEquals(new CentreContextConfig(false, false, false, true, false, null, empty(), empty()), config);
    }
    ...
    public void context_with_current_entity_and_selection_crit() {
       ...
       assertEquals(new CentreContextConfig(true, false, true, false, false, null, empty(), empty()), config);
    }
    ...
    public void context_with_current_entity_and_master_entity() {
       ...
       assertEquals(new CentreContextConfig(true, false, false, true, false, null, empty(), empty()), config);
    }
    ...
    public void context_with_selected_entities_and_selection_crit() {
       ...
       assertEquals(new CentreContextConfig(false, true, true, false, false, null, empty(), empty()), config);
    }
    ...
    public void context_with_selected_entities_and_master_entity() {
       ...
       assertEquals(new CentreContextConfig(false, true, false, true, false, null,  empty(), empty()), config);
    }
    ...
    public void context_with_master_entity_and_selection_crit() {
       ...
       assertEquals(new CentreContextConfig(false, false, true, true, false, null, empty(), empty()), config);
    }
    ...
    public void context_with_master_entity_and_selection_crit_and_curr_entity() {
       ...
       assertEquals(new CentreContextConfig(true, false, true, true, false, null, empty(), empty()), config);
    }
    ...
    public void context_with_master_entity_and_selection_crit_and_selected_entities() {
       ...
       assertEquals(new CentreContextConfig(false, true, true, true, false, null, empty(), empty()), config);
    }
    ...
    public void context_with_selected_entities_and_selection_crit_and_related_contexts() {
       ...
       assertEquals(new CentreContextConfig(false, true, true, false, false, null, of(relatedContexts), empty()), config);
    }
    ...
    public void context_with_selected_entities_and_selection_crit_and_parent_centre_contexts() {
       ...
       assertEquals(new CentreContextConfig(false, true, true, false, false, null, empty(), of (context().withSelectionCrit().withSelectedEntities().build())), config);
    }
    ...
    public void context_referentially_identical_computation_components_are_equal() {
       ...
       assertEquals(new CentreContextConfig(false, true, true, true, false, computation, empty(), empty()), config);
