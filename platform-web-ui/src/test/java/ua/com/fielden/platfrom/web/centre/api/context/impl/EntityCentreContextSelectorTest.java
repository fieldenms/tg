...
public class EntityCentreContextSelectorTest {
    ...
    public void context_with_current_entity_and_selection_crit() {
       ...
       assertEquals(new CentreContextConfig(true, false, true, false, null, empty()), config);
    }
    ...
    public void context_with_current_entity_and_master_entity() {
       ...
       assertEquals(new CentreContextConfig(true, false, false, true, null, empty()), config);
    }
    ...
    public void context_with_selected_entities_and_selection_crit() {
       ...
       assertEquals(new CentreContextConfig(false, true, true, false, null, empty()), config);
    }
    ...
    public void context_with_selected_entities_and_master_entity() {
       ...
       assertEquals(new CentreContextConfig(false, true, false, true, null,  empty()), config);
    }
    ...
    public void context_with_master_entity_and_selection_crit() {
       ...
       assertEquals(new CentreContextConfig(false, false, true, true, null, empty()), config);
    }
    ...
    public void context_with_master_entity_and_selection_crit_and_curr_entity() {
       ...
       assertEquals(new CentreContextConfig(true, false, true, true, null, empty()), config);
    }
    ...
    public void context_with_master_entity_and_selection_crit_and_selected_entities() {
       ...
       assertEquals(new CentreContextConfig(false, true, true, true, null, empty()), config);
    }
    ...
    public void context_referentially_identical_computation_components_are_equal() {
       ...
       assertEquals(new CentreContextConfig(false, true, true, true, computation, empty()), config);
