...
\section*{Security Objectives}\label{sec:01}
	...
	As such they identify the primary security-related activities that are included into our current software engineering processes, and are enabled by the underlying software development technology.
	...
	\hyperref[sec:01:fig:1]{Fig.~\ref*{sec:01:fig:1}} represents a high-level security diagram, which outlines a security context for TG applications and these security objectives.

	\begin{figure}[h!tbp]
	\centering
	\hspace*{-5.5cm}
	\includegraphics[scale=0.35]{images/01-security-diagram.pdf}
