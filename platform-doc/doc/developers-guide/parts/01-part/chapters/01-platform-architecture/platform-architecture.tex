...
\subsection{Compile Time Meta-Data}
  ...
  Each entity has a notion of a \emph{business key} that consists of one or several entity properties\footnote{The concept of \emph{property} is defined further in text. At this stage it should be thought of as a field with some additional information associated with it.}, which together uniquely identify an instance of a given entity type.
