...
\subsection{Modifying User Interface}
  ...
  However, in order to synchronise the MVP nomenclature with the nomeclature of the platfrom, it was renamed into Domain-Model-View (DMV):
  \begin{description}
  ...
  The diagram of the MVP pattern principal difference between the two 
