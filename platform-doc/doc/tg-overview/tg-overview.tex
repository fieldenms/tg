...
private Technician technician;
	...
	\begin{figure}[!h]
  		\centering
        \includegraphics[width=0.7\textwidth]{images/06-wa-detail-master.png}  
...
public class WorkActivityDetailCo 
	...
	Last, but not least, we will discuss declarative domain security and how RESTful Objects deliver GraphQL-based Web API by following the direct manipulation principle in the same way as with UI.
