...
private Service service;
	...
	\tcblower
	\tiny
	Property \texttt{service} in entity \texttt{WorkActivity}.
	It is declared as persistent, which means it gets saved into a database.
	...
	In addition to a proper validation mechanism 
