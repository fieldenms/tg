...
private Technician technician;
	...
	We argue that similar benefits are gained at the level of domain modelling.
  	There is a lot of semantic similarities between REST style of web resources (macro level) and objects modelling of a business domain (micro level).
	...
	As is the case with REST web resources, the they may or may not be applicable to a specific entity object in question.
	...
	An entity can model a business process, such as purchase order authorisation.
	...
	Thus, any object may have many, often unrelated, methods that try to capture different behavioural aspects of some business entity.
