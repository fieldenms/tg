...
\subsubsection*{Unique object-oriented architectural style to uniform modelling of the business domain}
	One could argue that commanding a programming language is relatively easy. 
  	...
  	This protects developers from a multitude of programming errors provisioning for getting a working solution in short terms that could be easily supported by both the original or new developers.
...
\subsubsection*{A software construction tool to facilitate the process management}
	...
	These project management approaches exist for a good reason and there are multiple tools that assists with their implementation and practices at business organisations.
