...
\hypersetup{
    ...
    pdfcopyright={Copyright (C) 2020 by Fielden Management Services Pty Ltd.  All rights reserved.}
}

\usepackage{xcolor}
\makeevenhead{headings}%
    {\thepage}{}{\slshape\bookname~\thebook\qquad\partname~\thepart\qquad\leftmark}
    \makeoddfoot{headings}{\slshape\rightmark}{\color{gray}Copyright (C) 2020 by Fielden Management Services Pty Ltd.  All rights reserved.}{\thepage}
