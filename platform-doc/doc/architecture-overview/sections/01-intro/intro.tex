...
\section{Motivation -- the ``why'' behind TG}\label{sec:01}
  ...
  The two sides of the gap are briged only by the software developer(s) who has built the solution and holds the transition model in their mind.
