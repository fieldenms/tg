\section{DSL + Types + Metadata == Business Modeling}\label{sec:03}
  ...
  There are three principle compounds that are at the foundation of every business application based on the Trident Genesis platform: Domain Specific Languages, Type System and Metadata.
...
\subsection{Domain Specific Languages}
  ...
  In fact, there are well established solutions for business software that exist for a long time and explicitly utilise this concept.
  ...
  An opposite to external DSL is the concept of \emph{internal DSL} -- a specialised language, which utilises the capabilities of a specific general purpose programming language (host language) to express language-like constructs that can be used together with the general purpose programming language.
  Internal DSLs share the development and execution infrastructure of the corresponding general purpose programming language taking a significant advantage of existing debugging, profiling tools, code editors, programming libraries etc.
...
\subsection{Type System and Metadata}
  ...
  Based on this information, the platform automatically constructs a large part of the application internals that provides support for a complete application life-cycle.
  ...
  The notion of \emph{model} here means not only the business model as outline previously, but a complete \emph{programming} model provided by the platform.
  ...
  The software development is performed in the unified system of concepts.
  This establishes a ubiquitous language carried out through all stages of development and support for all applications.
...
\subsection{Domain Model Reuse}
  ...
  This is especially critical if there are several business applications developed for the same or similar business domain, but different customers, as it greatly simplifies and improves application support (common enhancements, bug fixes etc.).
