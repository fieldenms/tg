...
public class UserRoleTokensUpdater_CanExecute_Token implements ISecurityToken {
    private final static String ENTITY_TITLE = TitlesDescsGetter.getEntityTitleAndDesc(UserRoleTokensUpdater.class).getKey();
