...
/**
 * A security token for entity {@link TgEntityForColourMaster} to guard MASTER_OPEN.
 * 
 * @author TG Team
 */
public class TgEntityForColourMasterMaster_CanOpen_Token
    implements ISecurityToken
{
    private final static String ENTITY_TITLE = (TitlesDescsGetter.getEntityTitleAndDesc(TgEntityForColourMaster.class).getKey()+" Master");
