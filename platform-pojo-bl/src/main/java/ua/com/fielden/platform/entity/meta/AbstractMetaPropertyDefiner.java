...
/**
 * An abstract implementation of {@link IMetaPropertyDefiner} that provides a helper method that looks for a property and returns its method.
 * 
 * @author 01es
 * 
 */
public abstract class AbstractMetaPropertyDefiner implements IMetaPropertyDefiner {
