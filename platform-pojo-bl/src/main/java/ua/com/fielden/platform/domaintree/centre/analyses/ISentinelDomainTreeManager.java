...
/**
 * This interface defines how domain tree can be managed for special <b>sentinel analyses</b> (single "status" property distribution by "countOfSelf" aggregation). <br><br>
 *
...
public interface ISentinelDomainTreeManager extends IAnalysisDomainTreeManager {
    ...
    /**
     * This interface defines how domain tree can be managed for <b>sentinel analyses</b> specific ("add to distribution"). (Should return single used property -- "status" property e.g. "RED", "GREEN"). <br><br>
     *
     * @author TG Team
     * @see IUsageManager
     *
    ...
    /**
     * This interface defines how domain tree can be managed for <b>sentinel analyses</b> specific ("add to aggregation"). (Should return single used property -- "countOfSelf" aggregation property).<br><br>
     *
     * @author TG Team
     *
     */
