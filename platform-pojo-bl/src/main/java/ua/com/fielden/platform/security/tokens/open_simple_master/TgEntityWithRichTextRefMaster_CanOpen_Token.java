...
/**
 * A security token for entity {@link TgEntityWithRichTextRef} to guard master open.
 *
 * @author TG Team
 */
public class TgEntityWithRichTextRefMaster_CanOpen_Token implements ISecurityToken {
    private final static String ENTITY_TITLE = (TitlesDescsGetter.getEntityTitleAndDesc(TgEntityWithRichTextRef.class).getKey()+" Master");
