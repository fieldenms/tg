...
/**
 * A security token for entity {@link TgCompoundEntityDetail} to guard MASTER_OPEN.
 * 
 * @author TG Team
 */
public class TgCompoundEntityDetailMaster_CanOpen_Token
    implements ISecurityToken
{
    private final static String ENTITY_TITLE = (TitlesDescsGetter.getEntityTitleAndDesc(TgCompoundEntityDetail.class).getKey()+" Master");
