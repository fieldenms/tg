...
/**
 * Annotation for defining properties that should not be changed once they attain their value (i.e., become immutable).
 * The modus operandi of this annotation is controlled by attributes {@code nullIsValueForPersisted} and {@code persistedOnly}.
 * <p>
 ...
 * However, this semantics can be changed in application to persisted entities by setting attribute {@code nullIsValueForPersisted} to {@code true}.
 * <p>
