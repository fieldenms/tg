...
/**
 * A security token for entity {@link TgCollectionalSerialisationParent} to guard MASTER_OPEN.
 * 
 * @author TG Team
 */
public class TgCollectionalSerialisationParentMaster_CanOpen_Token
    implements ISecurityToken
{
    private final static String ENTITY_TITLE = (TitlesDescsGetter.getEntityTitleAndDesc(TgCollectionalSerialisationParent.class).getKey()+" Master");
