 ...
 *
 */
public class MonthsTokenAutomata extends BaseNonDeterministicAutomata {

    public MonthsTokenAutomata() {
	super(EgTokenCategory.MONTHS, TEXT_POST_PROCESSING.REMOVE_WS, new State0(), new State1(), new State2(), new State3(), new State4(), new State5(), new State6(), new State7());
    }
