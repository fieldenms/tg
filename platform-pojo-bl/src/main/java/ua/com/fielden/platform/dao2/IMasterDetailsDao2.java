 ...
 * @param <D>
 */
public interface IMasterDetailsDao2<M extends AbstractEntity<?>, D extends AbstractEntity<?>> {
    /**
     ...
     * @return
     */
    IPage2<D> findDetails(final M masterEntity, fetch<D> model, final int pageCapacity);
