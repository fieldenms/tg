...
public class EQLParser extends Parser {
	...
	public static class YieldOperandConcatOfContext extends YieldOperandContext {
		...
		public SingleOperandContext singleOperand;
		public List<SingleOperandContext> orderOperands = new ArrayList<SingleOperandContext>();
		public OrderContext order;
		public List<OrderContext> orderDirections = new ArrayList<OrderContext>();
		...
		public List<TerminalNode> ORDERBY() { return getTokens(EQLParser.ORDERBY); }
		public TerminalNode ORDERBY(int i) {
			return getToken(EQLParser.ORDERBY, i);
		}
		...
		try {
			...
			case CONCATOF:
				...
				while (_la==ORDERBY) {
					...
					match(ORDERBY);
					setState(435);
					((YieldOperandConcatOfContext)_localctx).singleOperand = singleOperand();
					((YieldOperandConcatOfContext)_localctx).orderOperands.add(((YieldOperandConcatOfContext)_localctx).singleOperand);
					setState(436);
					((YieldOperandConcatOfContext)_localctx).order = order();
					((YieldOperandConcatOfContext)_localctx).orderDirections.add(((YieldOperandConcatOfContext)_localctx).order);
					}
					}
					setState(442);
					_errHandler.sync(this);
