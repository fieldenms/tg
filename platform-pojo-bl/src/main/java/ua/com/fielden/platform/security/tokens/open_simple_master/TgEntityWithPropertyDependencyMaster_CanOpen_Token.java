...
/**
 * A security token for entity {@link TgEntityWithPropertyDependency} to guard MASTER_OPEN.
 * 
 * @author TG Team
 */
public class TgEntityWithPropertyDependencyMaster_CanOpen_Token
    implements ISecurityToken
{
    private final static String ENTITY_TITLE = (TitlesDescsGetter.getEntityTitleAndDesc(TgEntityWithPropertyDependency.class).getKey()+" Master");
