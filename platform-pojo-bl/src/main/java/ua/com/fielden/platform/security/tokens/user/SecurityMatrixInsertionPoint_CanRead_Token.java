...
/**
 * A security token for entity {@link SecurityMatrixInsertionPoint} to guard READ.
 *
 * @author TG Team
 */
public class SecurityMatrixInsertionPoint_CanRead_Token implements ISecurityToken {
    private final static String ENTITY_TITLE = TitlesDescsGetter.getEntityTitleAndDesc(SecurityMatrixInsertionPoint.class).getKey();
