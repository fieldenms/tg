 ...
 *
 * Consists of all {@link ICriteriaDomainTreeManager} logic and some special indicators that are specific for locators, like <code>searchBy</code> or <code>useForAutocompletion</code> etc.
 *
 * @author TG Team
 *
 */
public interface ILocatorDomainTreeManager extends ICriteriaDomainTreeManager {
    /**
