...
/**
 * Represents a "function" (of single argument) concept for properties in domain tree representations. <br><br>
 *
 ...
 * 3) attributed collectional property<br><br>
 *
 * An expression should be defined in eQuery manner as simply query string (see {@link #equeryString(String)} method). To complete function definition
 * the result type should be defined (it can differ from type of property, see {@link #resultType(Class)} method).
 *
 * @author TG Team
 *
 */
public enum Function /* implements Serializable */ {
	...
	public Set<Class<?>> argumentTypes() {
	    return new HashSet<Class<?>>() { { add(AbstractEntity.class); add(String.class); add(Money.class); add(Number.class); add(boolean.class); add(Date.class); } };
	}
    },
    /**
     ...
     *
     * IMPORTANT : Distinct Count function can be applicable to all Finite types of arguments (Boolean, {@link AbstractEntity} type, properties like
     * "year of date property", "count of collection" etc.).
     *
     */
	...
	@Override
	public Set<Class<?>> argumentTypes() {
	    return new HashSet<Class<?>>() { { add(boolean.class); add(AbstractEntity.class); add(Integer.class); /* please pay attention to cases of Integer usage. */ } };
	}
    },
	...
	@Override
	public Set<Class<?>> argumentTypes() {
	    return new HashSet<Class<?>>() { { add(Number.class); add(Money.class); } };
	}
    },
	...
	@Override
	public Set<Class<?>> argumentTypes() {
	    return new HashSet<Class<?>>() { { add(Number.class); add(Money.class); add(Date.class); add(String.class); } };
	}
    },
     ...
     *
     * @param title -- a title of this function
     * @param desc -- a description of this function
     * @param equeryName -- strict eQuery name for function
     */
     ...
     *
     * @param argumentType -- a type of property for which a function is applied.
     * @return
     */
    public Class<?> resultType(final Class<?> argumentType) {
