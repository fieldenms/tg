 ...
 * <p>
 * Similarly to {@link Handler}, named parameters can be provided if required. All provided parameters are set for the handler instance using field with the name matching the
 * parameter name. Thus, each handler class must have fields for each specified parameter.
 * <p>
