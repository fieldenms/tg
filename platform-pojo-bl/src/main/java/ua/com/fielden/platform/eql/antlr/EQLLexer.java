...
public class EQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"BEGINEXPR", "BEGINYIELDEXPR", "BETWEEN", "CASEWHEN", "CEIL", "CONCAT", 
			...
			"EXTPROP", "FLOOR", "GE", "GROUPBY", "GT", "HOUROF", "HOURS", "IFNULL", 
			"ILIKE", "ILIKEWITHCAST", "IN", "IPARAM", "IPARAMS", "ISNOTNULL", "ISNULL", 
			"IVAL", "JOIN", "LE", "LEFTJOIN", "LIKE", "LIKEWITHCAST", "LIMIT", "LOWERCASE", 
