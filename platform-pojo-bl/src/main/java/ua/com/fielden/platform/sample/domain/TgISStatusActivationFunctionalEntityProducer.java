 ...
 *
 */
public class TgISStatusActivationFunctionalEntityProducer extends DefaultEntityProducer<TgISStatusActivationFunctionalEntity> implements IEntityProducer<TgISStatusActivationFunctionalEntity> {
