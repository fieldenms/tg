...
/**
 * Represents a BCE handler parameter of non-ordinary type. The provided class is instantiated upon handler creation using an instance of injector.
 * Thus, the specified class value can be only one of the following:
 * <ul>
