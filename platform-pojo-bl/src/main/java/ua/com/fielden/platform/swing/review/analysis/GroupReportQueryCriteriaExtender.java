...
public abstract class GroupReportQueryCriteriaExtender<T extends AbstractEntity, DAO extends IEntityDao<T>, R> extends EntityQueryCriteriaExtender<T, DAO, R> {
    ...
    //    @Override
    //    public R runExtendedQuery(final int pageSize) {
    ...
    //
    //    @Override
    //    public R exportExtendedQueryData() {
