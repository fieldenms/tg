...
/**
 * This interface defines how domain tree "tick" can be represented for base "add to result" functionality. <br>
 * <br>
 * 
...
public interface IOrderingRepresentation {
     ...
     * assigned). If you want to disable <b>ordering</b> for "concrete" property -- use {@link #disableOrderingImmutably(Class, String)} method. <br>
     * <br>
     * 
     ...
     * (based on i.e. types, nature, parents, annotations assigned) -- use {@link #isOrderingDisabledImmutably(Class, String)} method. <br>
     * <br>
     * 
     * <b>IMPORTANT</b> : the disabled <b>immutably</b> property's <b>ordering</b> could not be enabled anymore.
     * 
