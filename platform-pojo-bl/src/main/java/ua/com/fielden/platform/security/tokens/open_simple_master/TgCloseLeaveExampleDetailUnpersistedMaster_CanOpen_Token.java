...
/**
 * A security token for entity {@link TgCloseLeaveExampleDetailUnpersisted} to guard MASTER_OPEN.
 * 
 * @author TG Team
 */
public class TgCloseLeaveExampleDetailUnpersistedMaster_CanOpen_Token
    implements ISecurityToken
{
    private final static String ENTITY_TITLE = (TitlesDescsGetter.getEntityTitleAndDesc(TgCloseLeaveExampleDetailUnpersisted.class).getKey()+" Master");
