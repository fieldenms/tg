...
/**
 * NDA for recognising MINUTE token of the expression language.
 *
 * @author TG Team
 *
 */
public class MinuteTokenAutomata extends BaseNonDeterministicAutomata {

    public MinuteTokenAutomata() {
	super(EgTokenCategory.MINUTE, TEXT_POST_PROCESSING.REMOVE_WS, new State0(), new State1(), new State2(), new State3(), new State4(), new State5(), new State6(), new State7());
    }
