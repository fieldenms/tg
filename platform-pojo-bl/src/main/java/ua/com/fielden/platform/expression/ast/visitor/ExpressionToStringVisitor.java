...
/**
 * A demo visitor, which simply constructs postfix, prefix or infix form (this depends on the tree walking algorithm) of the expression while visiting an AST tree. It can be used
 * conveniently for testing purposes.
 * 
 * @author TG Team
 * 
 */
