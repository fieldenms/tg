...
/**
 * Should be thrown to indicate that a token in question is used in place where it should not be used. For example, keyword SELF whould only be used as part of function COUNT call.
 * 
 * @author TG Team
 */
