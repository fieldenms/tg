 ...
 */
@PublicApi
public class TgPropertyDataFetcher<T> implements LightDataFetcher<T> {
     ...
     */
    public TgPropertyDataFetcher(final String propertyName) {
        this.propertyName = Assert.assertNotNull(propertyName);
        this.function = null;
    }

    @SuppressWarnings("unchecked")
    private <O> TgPropertyDataFetcher(final Function<O, T> function) {
     ...
     *
     * @return a new TgPropertyDataFetcher using the provided function as its source of values
     */
    public static <T> TgPropertyDataFetcher<T> fetching(final String propertyName) {
        return new TgPropertyDataFetcher<>(propertyName);
    }
     ...
     * @return a new TgPropertyDataFetcher using the provided function as its source of values
     */
    public static <T, O> TgPropertyDataFetcher<T> fetching(final Function<O, T> function) {
        return new TgPropertyDataFetcher<>(function);
    }
    ...
    @Override
    public T get(final GraphQLFieldDefinition fieldDefinition, final Object source, final Supplier<DataFetchingEnvironment> environmentSupplier) throws Exception {
    ...
    @SuppressWarnings("unchecked")
    private T getImpl(final Object source, final GraphQLOutputType fieldDefinition, final Supplier<DataFetchingEnvironment> environmentSupplier) {
        if (source == null) {
            return null;
        }
        ...
        return (T) TgPropertyDataFetcherHelper.getPropertyValue(propertyName, source, fieldDefinition, environmentSupplier);
    }

    /**
     * TgPropertyDataFetcher caches the methods and fields that map from a class to a property for runtime performance reasons
    ...
    public static void clearReflectionCache() {
        TgPropertyDataFetcherHelper.clearReflectionCache();
    }

    /**
     * This can be used to control whether TgPropertyDataFetcher will use {@link java.lang.reflect.Method#setAccessible(boolean)} to gain access to property
     * values.  By default it TgPropertyDataFetcher WILL use setAccessible.
     *
    ...
    public static boolean setUseSetAccessible(final boolean flag) {
        return TgPropertyDataFetcherHelper.setUseSetAccessible(flag);
    }

    /**
     * This can be used to control whether TgPropertyDataFetcher will cache negative lookups for a property for performance reasons.  By default it TgPropertyDataFetcher WILL cache misses.
     *
    ...
    public static boolean setUseNegativeCache(final boolean flag) {
        return TgPropertyDataFetcherHelper.setUseNegativeCache(flag);
    }
}