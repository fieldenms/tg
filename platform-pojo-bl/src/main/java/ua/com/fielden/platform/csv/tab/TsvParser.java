...
// $ANTLR 3.2 Sep 23, 2009 12:02:23 /home/oleh/ANTLR/Tsv.g 2011-02-25 13:16:48
...
public class TsvParser extends Parser implements IParser {
    ...
    // $ANTLR start "line"
    // /home/oleh/ANTLR/Tsv.g:19:1: line returns [List<String> result] : ( ( NEWLINE )=> NEWLINE | field ( COMMA field )* NEWLINE ) ;
	...
	try {
	    // /home/oleh/ANTLR/Tsv.g:22:2: ( ( ( NEWLINE )=> NEWLINE | field ( COMMA field )* NEWLINE ) )
	    // /home/oleh/ANTLR/Tsv.g:22:4: ( ( NEWLINE )=> NEWLINE | field ( COMMA field )* NEWLINE )
	    {
		// /home/oleh/ANTLR/Tsv.g:22:4: ( ( NEWLINE )=> NEWLINE | field ( COMMA field )* NEWLINE )
		int alt2 = 2;
		...
		switch (alt2) {
		case 1:
		    // /home/oleh/ANTLR/Tsv.g:23:6: ( NEWLINE )=> NEWLINE
		{
		    ...
		    break;
		case 2:
		    // /home/oleh/ANTLR/Tsv.g:24:8: field ( COMMA field )* NEWLINE
		{
		    ...
		    if (state.failed)
			return result;
		    // /home/oleh/ANTLR/Tsv.g:24:14: ( COMMA field )*
		    loop1: do {
			int alt1 = 2;
			...
			switch (alt1) {
			case 1:
			    // /home/oleh/ANTLR/Tsv.g:24:15: COMMA field
			{
    ...
    // $ANTLR start "field"
    // /home/oleh/ANTLR/Tsv.g:29:1: field : (f= QUOTED | f= UNQUOTED | ) ;
    public final void field() throws RecognitionException {
	Token f = null;

	try {
	    // /home/oleh/ANTLR/Tsv.g:30:2: ( (f= QUOTED | f= UNQUOTED | ) )
	    // /home/oleh/ANTLR/Tsv.g:30:4: (f= QUOTED | f= UNQUOTED | )
	    {
		// /home/oleh/ANTLR/Tsv.g:30:4: (f= QUOTED | f= UNQUOTED | )
		int alt3 = 3;
		switch (input.LA(1)) {
		...
		switch (alt3) {
		case 1:
		    // /home/oleh/ANTLR/Tsv.g:30:6: f= QUOTED
		{
		    ...
		    break;
		case 2:
		    // /home/oleh/ANTLR/Tsv.g:31:6: f= UNQUOTED
		{
	...
	// /home/oleh/ANTLR/Tsv.g:23:6: ( NEWLINE )
	// /home/oleh/ANTLR/Tsv.g:23:7: NEWLINE
	{
	    match(input, NEWLINE, FOLLOW_NEWLINE_in_synpred1_Tsv42);
	    if (state.failed)
		return;
