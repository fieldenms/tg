...
/**
 * Stub validator, which should be used strictly for association of validation results in cases where there is no real validator.
 * For example, property requiredness does not use any validator and validation login in setter does not use any validator.
 *
 * @author TG Team
 *
 */
