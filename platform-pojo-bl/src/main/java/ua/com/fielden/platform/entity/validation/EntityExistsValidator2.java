...
/**
 * Validator that checks entity value for existence using an {@link IEntityDao2} instance.
 *
 ...
 *
 */
public class EntityExistsValidator2 implements IBeforeChangeEventHandler<Object> {

    private IEntityDao2 controller;

    protected EntityExistsValidator2() {
    }

    public EntityExistsValidator2(final IEntityDao2 dao) {
	this.controller = dao;
    }
