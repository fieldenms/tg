...
public class CopyUserRoleAction_CanExecute_Token implements ISecurityToken {
    private final static String ENTITY_TITLE = TitlesDescsGetter.getEntityTitleAndDesc(CopyUserRoleAction.class).getKey();
