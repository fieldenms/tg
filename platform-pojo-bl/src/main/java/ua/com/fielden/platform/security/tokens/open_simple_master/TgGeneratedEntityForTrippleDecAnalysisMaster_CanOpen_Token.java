...
/**
 * A security token for entity {@link TgGeneratedEntityForTrippleDecAnalysis} to guard MASTER_OPEN.
 * 
 * @author TG Team
 */
public class TgGeneratedEntityForTrippleDecAnalysisMaster_CanOpen_Token
    implements ISecurityToken
{
    private final static String ENTITY_TITLE = (TitlesDescsGetter.getEntityTitleAndDesc(TgGeneratedEntityForTrippleDecAnalysis.class).getKey()+" Master");
