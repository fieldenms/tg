...
/**
 * A security token for entity {@link TgVehicleFuelUsage} to guard Web API querying.
 */
public class TgVehicleFuelUsage_WebApi_CanQuery_Token
    extends WebApiToken
{
    private static final String ENTITY_TITLE = TitlesDescsGetter.getEntityTitleAndDesc(TgVehicleFuelUsage.class).getKey();
    public static final String TITLE = String.format(WebApiTemplate.QUERY.forTitle(), ENTITY_TITLE);
    public static final String DESC = String.format(WebApiTemplate.QUERY.forDesc(), "tgVehicleFuelUsage");
}
