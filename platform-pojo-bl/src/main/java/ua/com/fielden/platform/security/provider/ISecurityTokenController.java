...
public interface ISecurityTokenController {
     ...
     */
    void saveSecurityToken(Map<Class<? extends ISecurityToken>, List<UserRole>> tokenToRoleAssocations);
    ...
    boolean canAccess(String username, final Class<? extends ISecurityToken> securityTokenClass);
}
