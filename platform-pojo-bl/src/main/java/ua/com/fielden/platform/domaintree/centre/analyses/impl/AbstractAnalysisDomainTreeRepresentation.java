...
public abstract class AbstractAnalysisDomainTreeRepresentation extends AbstractDomainTreeRepresentation implements IAbstractAnalysisDomainTreeRepresentation {
    ...
    /**
     * A first tick representation for "analyses" specific. <br>
     * <br>
     * 
     * A checked tick means that a property (some date functions can be applied) should be added to "analyses" distribution.<br>
     * <br>
     * 
    ...
    /**
     * A second tick representation for "analyses" specific. <br>
     * <br>
     * 
     * A checked tick means that a property (with a couple of aggregation parameters applied) should be added to "analyses" aggregation.<br>
     * <br>
     * 
     * For a collectional property an action "Create calculated property..." should be used to create aggregated property (or more complex expression).
     * 
    ...
    protected abstract static class AbstractAnalysisAddToAggregationTickRepresentation extends AbstractTickRepresentation implements IAbstractAnalysisAddToAggregationTickRepresentation {
        ...
        /**
         * A contract for reverse "enabling" of the properties. For e.g. in base analyses second tick we should enable only AGGREGATED_EXPRESSION properties. This contract can be
         * fully overridden to provide a very different functionality.
         * 
         * @param root
         * @param property
         * @return
        ...
        public boolean isOrderingDisabledImmutably(final Class<?> root, final String property) {
            ...
            illegalExcludedProperties(getDtr(), managedType, property, "Could not ask an 'ordering disablement' for already 'excluded' property [" + property + "] in type ["
        ...
        public IOrderingRepresentation disableOrderingImmutably(final Class<?> root, final String property) {
            ...
            illegalExcludedProperties(getDtr(), managedType, property, "Could not disable an 'ordering' for already 'excluded' property [" + property + "] in type ["
                    + managedType.getSimpleName() + "].");
