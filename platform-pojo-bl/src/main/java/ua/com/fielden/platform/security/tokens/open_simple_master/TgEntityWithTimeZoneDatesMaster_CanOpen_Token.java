...
/**
 * A security token for entity {@link TgEntityWithTimeZoneDates} to guard MASTER_OPEN.
 * 
 * @author TG Team
 */
public class TgEntityWithTimeZoneDatesMaster_CanOpen_Token
    implements ISecurityToken
{
    private final static String ENTITY_TITLE = (TitlesDescsGetter.getEntityTitleAndDesc(TgEntityWithTimeZoneDates.class).getKey()+" Master");
