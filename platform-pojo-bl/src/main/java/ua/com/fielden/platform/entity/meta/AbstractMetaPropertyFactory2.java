 ...
 *
 */
public abstract class AbstractMetaPropertyFactory2 implements IMetaPropertyFactory {
    ...
    protected final Map<Class<? extends AbstractEntity>, EntityExistsValidator2> entityExistsValidators = Collections.synchronizedMap(new HashMap<Class<? extends AbstractEntity>, EntityExistsValidator2>());
    ...
    public AbstractMetaPropertyFactory2(final DomainValidationConfig domainConfig, final DomainMetaPropertyConfig domainMetaConfig) {
