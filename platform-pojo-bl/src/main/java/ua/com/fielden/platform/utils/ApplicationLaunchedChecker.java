...
public final class ApplicationLaunchedChecker {
    ...
    /**
     * Tries to acquire a lock on a designated file. If successful then there is no other instances of the application running -- returns false. The acquired lock remains until a
     * corresponding JVM is running to prevent launching of new application instances.
     * <p>
