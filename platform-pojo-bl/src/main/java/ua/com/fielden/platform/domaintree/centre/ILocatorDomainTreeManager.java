...
/**
 * This interface defines how domain tree can be managed for <b>locators</b>. <br>
 * <br>
 * 
 ...
 * <br>
 * 
 * Consists of all {@link ICentreDomainTreeManager} logic and some special indicators that are specific for locators, like <code>searchBy</code> or
 * <code>useForAutocompletion</code> etc.
 * 
 * @author TG Team
 * 
 */
public interface ILocatorDomainTreeManager extends ICentreDomainTreeManager {
    ...
    /**
     * Gets a <i>searchBy</i> flag for locator manager (see {@link SearchBy} for more details).<br>
     * <br>
     * 
     * @return
     */
    ...
    /**
     * Sets a <i>searchBy</i> flag for locator manager (see {@link SearchBy} for more details). <br>
     * <br>
     * 
     * @param searchBy
     *            -- a flag to set
    ...
    /**
     * Gets an <i>useForAutocompletion</i> flag for locator manager.<br>
     * <br>
     * 
     * @return
     */
    ...
    /**
     * Sets an <i>useForAutocompletion</i> flag for locator manager. <br>
     * <br>
     * 
     * @param useForAutocompletion
     *            -- a flag to set
     * @return -- a locator manager
     */
