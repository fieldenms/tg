...
// $ANTLR 3.2 Sep 23, 2009 12:02:23 /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g 2009-12-30 15:22:42
...
public class VbsvParser extends Parser implements IParser {
    ...
    // $ANTLR start "line"
    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:18:1: line returns [List<String> result] : ( ( NEWLINE )=> NEWLINE | field ( COMMA field )* NEWLINE ) ;
	...
	try {
	    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:21:2: ( ( ( NEWLINE )=> NEWLINE | field ( COMMA field )* NEWLINE ) )
	    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:21:4: ( ( NEWLINE )=> NEWLINE | field ( COMMA field )* NEWLINE )
	    {
		// /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:21:4: ( ( NEWLINE )=> NEWLINE | field ( COMMA field )* NEWLINE )
		int alt2 = 2;
		...
		switch (alt2) {
		case 1:
		    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:22:6: ( NEWLINE )=> NEWLINE
		{
		    ...
		    break;
		case 2:
		    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:23:8: field ( COMMA field )* NEWLINE
		{
		    ...
		    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:23:14: ( COMMA field )*
		    loop1: do {
			int alt1 = 2;
			...
			switch (alt1) {
			case 1:
			    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:23:15: COMMA field
			{
    ...
    // $ANTLR start "field"
    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:28:1: field : (f= QUOTED | f= UNQUOTED | ) ;
    public final void field() throws RecognitionException {
	Token f = null;

	try {
	    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:29:2: ( (f= QUOTED | f= UNQUOTED | ) )
	    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:29:4: (f= QUOTED | f= UNQUOTED | )
	    {
		// /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:29:4: (f= QUOTED | f= UNQUOTED | )
		int alt3 = 3;
		switch (input.LA(1)) {
		...
		switch (alt3) {
		case 1:
		    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:29:6: f= QUOTED
		{
		    ...
		    break;
		case 2:
		    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:30:6: f= UNQUOTED
		{
		    ...
		    break;
		case 3:
		    // /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:32:4:
		{
		}
		    break;
	...
	// /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:22:6: ( NEWLINE )
	// /home/yura/AntlrWorks-1.3.1/vertical-bar-separated-value line parser/Vbsv.g:22:7: NEWLINE
	{
	    match(input, NEWLINE, FOLLOW_NEWLINE_in_synpred1_Vbsv42);
	    if (state.failed) {
		return;
	    }
