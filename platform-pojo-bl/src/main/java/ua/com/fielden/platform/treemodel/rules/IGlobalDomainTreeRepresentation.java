...
/**
 * This interface defines how domain tree can be represented in the global client application scope.
 * At this stage only the <i>default locator managers</i> can represented in global client application scope. <br><br>
 *
 * @author TG Team
 *
 */
public interface IGlobalDomainTreeRepresentation {
    /**
     * Defines a contract which <i>entity-typed</i> properties have what locator manager by <b>default</b>. <br><br>
     *
     * The method is concentrated on the "types" of properties that should be have locator managers assigned.
     * If you want to change locator manager for "concrete" property type -- use {@link #excludeImmutably(Class, String)} method. <br><br>
     *
     * Throws {@link IllegalArgumentException} when the property is not of {@link AbstractEntity} type.
     *
     * @param propertyType -- a property type for which a default locator manager instance is asked.
     * @return
     */
     ...
     *
     * Throws {@link IllegalArgumentException} when the property is not of {@link AbstractEntity} type.
     * Throws {@link Result} when non-base user is trying to set default locator (see {@link IGlobalDomainTreeManager#getUserProvider()}).
     *
     * @param propertyType -- a property type for which a default locator manager instance is asked.
