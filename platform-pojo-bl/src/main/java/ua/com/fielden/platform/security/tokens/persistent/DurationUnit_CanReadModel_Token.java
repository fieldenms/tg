...
public class DurationUnit_CanReadModel_Token implements ISecurityToken {
    public final static String TITLE = format(READ_MODEL.forTitle(), DurationUnit.ENTITY_TITLE);
    public final static String DESC = format(READ_MODEL.forDesc(), DurationUnit.ENTITY_TITLE);
}