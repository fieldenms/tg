package ua.com.fielden.platform.treemodel.rules.master;

import ua.com.fielden.platform.treemodel.rules.ILocatorManager;
import ua.com.fielden.platform.treemodel.rules.IRootTyped;


/**
 * This interface defines how domain tree can be managed for <b>entity masters</b>. <br><br>
 *
 ...
 *
 * 1. Entity master can be configured in means of its locators.
 * 2. TODO In future : properties checking, moving, etc. (entity master contents design)
 *
 * @author TG Team
 */
