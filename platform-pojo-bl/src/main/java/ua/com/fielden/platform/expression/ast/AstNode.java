...
public class AstNode {
    ...
    /**
     * Should return an actual <code>value</code> of the <code>type</code> represented by this node instance. May return <code>null</code> if value was not yet determined or not
     * applicable.
     * 
     * @return
     */
