...
/**
 * This interface defines how domain tree can be represented for special <b>sentinel analyses</b> (single "status" property distribution by "countOfSelf" aggregation). <br><br>
 *
