 ...
 * @param <T>
 */
public class PojoValueMatcher2<T extends AbstractEntity<?>> implements IValueMatcher2<T> {
    ...
    public PojoValueMatcher2(final Collection<T> instances, final String expression, final int limit) {
	this(instances, expression, limit, false);
    }

    public PojoValueMatcher2(final Collection<T> instances, final String expression, final int limit, final boolean isCaseSensitive) {
