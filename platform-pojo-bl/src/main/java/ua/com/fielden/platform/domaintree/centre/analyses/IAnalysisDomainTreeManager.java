...
/**
 * This interface defines how domain tree can be managed for simple <b>analyses</b> (single property distribution). <br>
 * <br>
 * 
...
public interface IAnalysisDomainTreeManager extends IAbstractAnalysisDomainTreeManager {
     ...
     * 
     * @param visibleDistributedValuesNumber
     *            -- a value to set
    ...
    /**
     * This interface defines how domain tree can be managed for <b>analyses</b> specific ("add to distribution"). (Should return single used property). <br>
     * <br>
     * 
     * @author TG Team
     * @see IUsageManager
    ...
    /**
     * This interface defines how domain tree can be managed for <b>analyses</b> specific ("add to aggregation"). (no special enhancements).<br>
     * <br>
     * 
     * @author TG Team
     * 
