...
/**
 * A security token for entity {@link TgEntityTwoEntityKeys} to guard Web API querying.
 */
public class TgEntityTwoEntityKeys_WebApi_CanQuery_Token
    extends WebApiToken
{
    private static final String ENTITY_TITLE = TitlesDescsGetter.getEntityTitleAndDesc(TgEntityTwoEntityKeys.class).getKey();
    public static final String TITLE = String.format(WebApiTemplate.QUERY.forTitle(), ENTITY_TITLE);
    public static final String DESC = String.format(WebApiTemplate.QUERY.forDesc(), "tgEntityTwoEntityKeys");
}
