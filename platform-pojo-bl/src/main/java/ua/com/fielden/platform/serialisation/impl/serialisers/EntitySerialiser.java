...
public final class EntitySerialiser extends Serializer {
    ...
    public EntitySerialiser(final Kryo kryo, final Class<AbstractEntity> type, final EntityFactory factory) {
        ...
        final KeyType keyAnnotation = AnnotationReflector.getAnnotation(type, KeyType.class);

        if (keyAnnotation != null) {
            hasCompositeKey = DynamicEntityKey.class.isAssignableFrom(keyAnnotation.value());
        } else {
