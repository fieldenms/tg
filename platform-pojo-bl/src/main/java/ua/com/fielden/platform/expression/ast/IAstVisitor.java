...
public interface IAstVisitor {
    /**
     * Should encapsulate logic executed upon visitation of the provided node.
     * The post-, pre- and inner- order of method execution is determined by the tree walker implementation.
     *
     * @param node
     */
