...
/**
 * This interface defines how domain tree can be managed. <br>
 * <br>
 * 
...
public interface IDomainTreeManager {
     ...
     * This interface defines how domain tree can be managed. <br>
     * <br>
     * Domain tree consists of a tree of properties. Each property has two true-false modifiers.<br>
     * <br>
     * 
     * <b>Important:</b> it is necessary to override {@link #equals(Object)} and {@link #hashCode()} methods in implementors to provide logical comparison of instances. <br>
     * <br>
    ...
    public interface ITickManager {
         ...
         * want to check "concrete" property's tick -- use {@link #check(Class, String)} method. <br>
         * <br>
         * 
         * @param root
        ...
        /**
         * Moves property <code>what</code> to the place <b>before</b> property <code>beforeWhat</code> in an ordered list of checked properties for concrete <code>root</code>
         * type.
         * 
         * @param root
         *            -- a root type that contains a checked properties.
