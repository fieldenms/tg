...
@MapEntityTo
@AuditPropFor(AuditedEntity_a3t_1.class)
...
public class AuditedEntity_a3t_1_Prop extends AbstractAuditProp<AuditedEntity_a3t_1> {
  ...
  @IsProperty
  private AuditedEntity_a3t_1 auditEntity;
  ...
  public AuditedEntity_a3t_1 getAuditEntity() {
    return this.auditEntity;
  }

  @Observable
  public AuditedEntity_a3t_1_Prop setAuditEntity(final AuditedEntity_a3t_1 auditEntity) {
  ...
  @Observable
  public AuditedEntity_a3t_1_Prop setProperty(final PropertyDescriptor property) {
