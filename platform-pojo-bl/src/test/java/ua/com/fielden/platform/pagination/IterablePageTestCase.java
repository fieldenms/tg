...
public class IterablePageTestCase {
    ...
    private List<Entity> oneElement = new ArrayList<Entity>() {
        {
            add(new Entity());
        }
    };
    private List<Entity> twoElements = new ArrayList<Entity>() {
        {
            add(new Entity());
            add(new Entity());
        }
    };
    private List<Entity> threeElements = new ArrayList<Entity>() {
        {
            add(new Entity());
            add(new Entity());
            add(new Entity());
