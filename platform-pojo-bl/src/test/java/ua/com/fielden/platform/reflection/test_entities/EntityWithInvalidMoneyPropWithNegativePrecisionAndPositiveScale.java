...
public class EntityWithInvalidMoneyPropWithNegativePrecisionAndPositiveScale extends AbstractEntity<String> {
    ...
    @Observable
    public EntityWithInvalidMoneyPropWithNegativePrecisionAndPositiveScale setNumericMoney(final Money value) {
