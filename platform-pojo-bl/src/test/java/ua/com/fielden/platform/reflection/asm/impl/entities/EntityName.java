...
/**
 * A test entity, which has a name and a property with type that starts with the same name.
 * This entity is used to test type modification where one of its properties has a type name that starts with the same name as the type being modified.
 *
 * @author TG Team
 *
 */
