...
public class FluencyApiTest extends TestCase {
    ...
    private static String[] functions = new String[] { "round", "now", "caseWhen", "lowerCase", "upperCase", "ifNull", "dateOf", "hourOf", "dayOf", "monthOf", "yearOf",
            "minuteOf", "secondOf", "count", "concat", "absOf" };
    ...
    private static String compare(final Set<String> set, final String[]... methods) {
        ...
        return (missingMethods.size() + obsoleteMethods.size()) == 0 ? null
                : ((missingMethods.size() > 0 ? "Missing: " + missingMethods : "") + (obsoleteMethods.size() > 0 ? (" Obsolete: " + obsoleteMethods) : ""));
    }
