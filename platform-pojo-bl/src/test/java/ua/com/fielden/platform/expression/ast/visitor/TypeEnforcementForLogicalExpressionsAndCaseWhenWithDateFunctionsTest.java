...
public class TypeEnforcementForLogicalExpressionsAndCaseWhenWithDateFunctionsTest {
    ...
    @Test
    public void test_type_determination_for_comparison_expression_with_AVG_DAYS_function_and_YEARS_function() throws RecognitionException, SequenceRecognitionFailed, SemanticException {
	...
	final Token[] tokens = new ExpressionLexer("" +
			"CASE WHEN MONTHS(dateProp, NOW) > 3m THEN \"Green\" \n" +
