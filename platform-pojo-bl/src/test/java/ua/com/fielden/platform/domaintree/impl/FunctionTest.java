...
public class FunctionTest {
    ...
    public void test_what_functions_are_applicable_to_what_argument_types() {
        // entity functions
        assertEquals("Incorrect applicable functions.", new HashSet<Function>() {
            {
                add(Function.SELF);
                add(Function.COUNT_DISTINCT);
                add(Function.ALL);
                add(Function.ANY);
            }
        }, FunctionUtils.functionsFor(AbstractEntity.class));
        assertEquals("Incorrect applicable functions.", new HashSet<Function>() {
            {
                add(Function.SELF);
                add(Function.COUNT_DISTINCT);
        ...
        }, FunctionUtils.functionsFor(EntityWithStringKeyType.class));
        // string functions
        assertEquals("Incorrect applicable functions.", new HashSet<Function>() {
            {
                add(Function.SELF);
        ...
        }, FunctionUtils.functionsFor(String.class));
        // number functions
        final HashSet<Function> numberFunctions = new HashSet<Function>() {
            {
                add(Function.SELF);
                add(Function.MIN);
                add(Function.MAX);
        ...
        }, FunctionUtils.functionsFor(Integer.class)); // added COUNT_DISTINCT to the list of default number functions
        // boolean functions
        assertEquals("Incorrect applicable functions.", new HashSet<Function>() {
            {
                add(Function.SELF);
        ...
        }, FunctionUtils.functionsFor(boolean.class));
        // date functions
        assertEquals("Incorrect applicable functions.", new HashSet<Function>() {
            {
                add(Function.SELF);
        ...
        }, FunctionUtils.functionsFor(Date.class));
    }
