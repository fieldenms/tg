...
public class AbstractDomainTreeRepresentationTest extends AbstractDomainTreeTest {
    ...
    public void test_that_manual_exclusion_is_correctly_reflected_in_Included_properties() {
        ...
        // the property has been excluded but subtree that contain it has not been loaded yet
        assertEquals("Incorrect included properties.", Arrays.asList("", "desc", "integerProp", "entityPropOfSelfType", "entityPropOfSelfType.dummy-property", "entityProp", "entityProp.dummy-property", "entityPropCollection", "entityPropCollection.dummy-property").toString(), dtm().includedProperties(MasterEntityForIncludedPropertiesLogic.class).toString());

        // the property has been excluded. after subtree that contain it has been loaded -- it shows that property is excluded.
        dtm().warmUp(MasterEntityForIncludedPropertiesLogic.class, "entityPropCollection");
        assertEquals("Incorrect included properties.", Arrays.asList("", "desc", "integerProp", "entityPropOfSelfType", "entityPropOfSelfType.dummy-property", "entityProp", "entityProp.dummy-property", "entityPropCollection", "entityPropCollection.moneyProp").toString(), dtm().includedProperties(MasterEntityForIncludedPropertiesLogic.class).toString());
    }
