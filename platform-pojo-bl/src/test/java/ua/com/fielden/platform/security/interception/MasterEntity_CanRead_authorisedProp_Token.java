...
///
public class MasterEntity_CanRead_authorisedProp_Token implements ISecurityToken {
    public final static String TITLE = format(Template.READ_PROP.forTitle(), MasterEntity.ENTITY_TITLE, "authorisedProp");
