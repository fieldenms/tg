...
public class ClassesRetrieverTest {
    ...
    public void testGetAllClassesInPackageDerivedFrom() {
            ...
            assertEquals("Incorrect number of classes in ua.com.fielden.platform.reflection package derived from ISomeInterface", 3, ClassesRetriever.getAllClassesInPackageDerivedFrom("target/test-classes", "ua.com.fielden.platform.reflection", ISomeInterface.class).size());
