...
/**
 * A test case to ensure correct functionality of the Breadth-First Search algorithm when the state space is a tree.
 *
 * @author TG Team
 *
 */
public class BfsAlgorithmForTreeTest {
    ...
    addChild(level1_3_1 = new TreeNode("level1_3_1")).//
