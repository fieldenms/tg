...
/**
 * A test case for {@link AsymmetricCypher}.
 * 
 * @author TG Team
 * 
 */
public class AsymmetricCypherTest {
    ...
    private final AsymmetricCypher cypher;

    public AsymmetricCypherTest() throws Exception {
        cypher = new AsymmetricCypher();
    }
    ...
    @Test
    public void long_text_is_encoded_and_decoded_correctely_using_default_separator() throws Exception {
    ...
    @Test
    public void long_text_is_encoded_and_decoded_correctely_using_specified_separator() throws Exception {
        final String textToEncode = "long text long text long text long text long text long text long text long text long text"; // over 53 bytes
        assertTrue("Text to encode is too short for this test.", textToEncode.getBytes().length > 53);
