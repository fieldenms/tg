...
public class EntityPropertyLifecycleTest {
    ...
    public void test_availability_calculation() {
        epl = createEPL();
        assertEquals("Availability calculated incorrectly.", new BigDecimal(29 - 20 + 42 - 36 + 55 - 47).setScale(EntityPropertyLifecycle.DEFAULT_SCALE).divide(new BigDecimal(29
                - 20 + 42 - 31 + 55 - 47).setScale(EntityPropertyLifecycle.DEFAULT_SCALE), RoundingMode.HALF_UP), epl.getAvailability()); // 0.000000001
    }
    ...
    public void test_valued_intervals_time_splitting_in_case_of_intersecting_intervals() {
        ...
        Pair<List<ValuedInterval>, List<ValuedInterval>> expected = new Pair<List<ValuedInterval>, List<ValuedInterval>>(Arrays.asList(new ValuedInterval(date(2), date(10), "Value 2"), //
        ...
        current = date(34);
        expected = new Pair<List<ValuedInterval>, List<ValuedInterval>>(Arrays.asList(new ValuedInterval(date(2), date(10), "Value 2"), //
                new ValuedInterval(date(20), date(29), "Value 2"), //
