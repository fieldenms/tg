...
public class AstWakingTest {
    ...
    @Test
    public void test_post_order_walking_of_expression_with_application_of_rules_term_op_term_op_term_with_lparen_sentense_rparen() throws RecognitionException,
            SequenceRecognitionFailed, SemanticException {
        final Token[] tokens = new ExpressionLexer("1 + (2.3 + property)").tokenize();
        final ExpressionParser parser = new ExpressionParser(tokens);
        final AstNode ast = parser.parse();
        final ExpressionToStringVisitor visitor = new ExpressionToStringVisitor();
    ...
    @Test
    public void test_post_order_walking_of_expression_with_application_of_rules_term_op_term_op_term_with_lparen_sentense_rparen_nested() throws RecognitionException,
            SequenceRecognitionFailed, SemanticException {
