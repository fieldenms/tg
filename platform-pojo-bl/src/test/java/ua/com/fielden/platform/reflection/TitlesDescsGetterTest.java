...
public class TitlesDescsGetterTest {
	...
	assertEquals("Should be equal.", new Pair<String, String>("Veh/Eqp" + add + add, "<html><i><b>Vehicle or other equipment</b></i><br><i>[Veh/Eqp" + add + add + "]</i></html>"), TitlesDescsGetter.getFullTitleAndDesc("c.c.vehicle", C.class));
	assertEquals("Should be equal.", new Pair<String, String>("Incident" + add + add + add + add + add + add, "<html><i><b>Incident with which this work order is associated.</b></i><br><i>[Incident" + add + add + add + add + add + add + "]</i></html>"), TitlesDescsGetter.getFullTitleAndDesc("c.c.c.c.c.c.incident", C.class));
    }
