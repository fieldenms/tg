...
public class ExpressionText2ModelConverter4DayTest {
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "(DAY(dateProperty) + intProperty + decimalProperty) * 2");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", BigDecimal.class, root.getType());

	final ExpressionModel func = expr().dayOf().prop("dateProperty").model();
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "(DAY(MAX(collectional.dateProperty)) + intProperty) * 2");
	final AstNode root = ev.convert();
	...
	final ExpressionModel func = expr().dayOf().expr(max).model();
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "(SUM(DAY(collectional.dateProperty)) + intProperty) * 2");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", Integer.class, root.getType());

	final ExpressionModel days = expr().dayOf().prop("collectional.dateProperty").model();
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "intProperty * intProperty / DAY(MIN(collectional.dateProperty))");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", BigDecimal.class, root.getType());

	final ExpressionModel min = expr().minOf().prop("collectional.dateProperty").model();
	final ExpressionModel dayOfMin = expr().dayOf().expr(min).model();
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "intProperty * intProperty / (DAY(MAX(collectional.dateProperty)) * intProperty)");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", BigDecimal.class, root.getType());

	final ExpressionModel max = expr().maxOf().prop("collectional.dateProperty").model();
	final ExpressionModel dayOfMax = expr().dayOf().expr(max).model();
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "entityProperty.intProperty * intProperty / (DAY(dateProperty) * intProperty)");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", BigDecimal.class, root.getType());
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "entityProperty.intProperty * DAY(entityProperty.dateProperty)");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", Integer.class, root.getType());

	final ExpressionModel func = expr().dayOf().prop("entityProperty.dateProperty").model();
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "entityProperty.intProperty * SUM(DAY(collectional.dateProperty))");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", Integer.class, root.getType());

	final ExpressionModel func = expr().dayOf().prop("collectional.dateProperty").model();
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "selfProperty.intProperty - COUNT(DAY(entityProperty.collectional.dateProperty))");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", Integer.class, root.getType());
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "DAY(MAX(entityProperty.collectional.dateProperty)) + COUNT(collectional.intProperty)");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", Integer.class, root.getType());
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "COUNT(DAY(collectional.dateProperty) + DAY(selfProperty.collectional.dateProperty))");
	try {
	    ev.convert();
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "COUNT(DAY(selfProperty.dateProperty) + DAY(entityProperty.dateProperty))");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", Integer.class, root.getType());
	...
	final ExpressionText2ModelConverter ev = new ExpressionText2ModelConverter(EntityLevel1.class, "COUNT(DAY(selfProperty.collectional.dateProperty)) + COUNT(DAY(entityProperty.collectional.dateProperty))");
	final AstNode root = ev.convert();
	assertEquals("Incorrect expression type", Integer.class, root.getType());
