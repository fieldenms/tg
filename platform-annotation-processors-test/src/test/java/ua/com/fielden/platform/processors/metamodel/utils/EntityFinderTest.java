...
public class EntityFinderTest {
    ...
    public void findDeclaredProperties_finds_only_declared_properties_in_User() {
      ...
      final String expectedProps = "key, roles, activeRoles, inactiveRoles, base, basedOnUser, email, active, ssoOnly";
    ...
    public void findProperties_finds_all_properties_in_User() {
      ...
      final List<String> expectedProps = List.of("key", "roles", "activeRoles", "inactiveRoles", "base", "basedOnUser", "email", "active", "ssoOnly", "refCount", "createdBy",
    ...
    public void processProperties_includes_desc_and_id_for_SuperUserWithDeclaredDesc() {
      ...
      final String expectedProps = "desc, key, roles, activeRoles, inactiveRoles, base, basedOnUser, email, active, ssoOnly, refCount, createdBy, createdDate, createdTransactionGuid, lastUpdatedBy, lastUpdatedDate, lastUpdatedTransactionGuid, id";
      assertEquals(expectedProps,
    ...
    public void processProperties_includes_desc_for_NoDescTitleAndNoDeclaredDesc_extending_type_with_DescTitle_annotation() {
        ...
        final String expectedProps = "key, roles, activeRoles, inactiveRoles, base, basedOnUser, email, active, ssoOnly, refCount, createdBy, createdDate, createdTransactionGuid, lastUpdatedBy, lastUpdatedDate, lastUpdatedTransactionGuid, desc, id";
        assertEquals(expectedProps,
                entityFinder.processProperties(props, entity).stream().map(p -> p.getSimpleName().toString()).collect(joining(", "))); 
    }
    // where
